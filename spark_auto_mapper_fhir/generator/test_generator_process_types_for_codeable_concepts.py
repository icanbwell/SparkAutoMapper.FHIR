...
def test_generator_process_types_for_codeable_concepts() -> None:
    ...
    resource_xsd_file: Path = data_dir.joinpath("xsd").joinpath("definitions.xml").joinpath("fhir-all-xsd").joinpath(resource)
    ...
    value_sets: List[
        FhirValueSet
    ] = FhirXmlSchemaParser.get_value_sets()
    print(value_sets)
