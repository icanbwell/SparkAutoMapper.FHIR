...
class FhirActSubstanceAdminSubstitutionCode(AutoMapperDataTypeLiteral):
    """
    ...
    class classproperty(object):
        def __init__(self, f: Callable[..., 'FhirActSubstanceAdminSubstitutionCode']) -> None:
            self.f: Callable[..., 'FhirActSubstanceAdminSubstitutionCode'] = f

        def __get__(self, obj: Any,
                    owner: Type['FhirActSubstanceAdminSubstitutionCode']) -> 'FhirActSubstanceAdminSubstitutionCode':
            return self.f(owner)
