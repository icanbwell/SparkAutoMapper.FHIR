...
from spark_auto_mapper_fhir.fhir_types.codes.coverage_type_and_self_pay import FhirCoverageTypeAndSelfPayCode
from spark_auto_mapper_fhir.fhir_types.codes.financial_resource_status import FhirFinancialResourceStatusCode
from spark_auto_mapper_fhir.fhir_types.codes.subscriber_relationship import FhirSubscriberRelationshipCode
...
class FhirCoverage(AutoMapperDataTypeComplexBase):
    ...
    def map(cls,
            ...
            type_: Optional[FhirCodeableConcept[FhirCoverageTypeAndSelfPayCode]] = None,
            policyHolder: Optional[FhirReference[
                Union[
                    FhirPatient,
                    FhirRelatedPerson,
                    FhirOrganization
            ...
            subscriber: Optional[FhirReference[
                Union[
                    FhirPatient,
                    FhirRelatedPerson
                ]
            ...
            relationship: Optional[FhirCodeableConcept[FhirSubscriberRelationshipCode]] = None,
            period: Optional[FhirPeriod] = None,
            class_: Optional[FhirList[FhirCoverageClassificationBackboneElement]] = None,
            order: Optional[FhirPositiveInt] = None,
            network: Optional[FhirString] = None,
            costToBeneficiary: Optional[FhirList[FhirCostToBeneficiaryBackboneElement]] = None,
