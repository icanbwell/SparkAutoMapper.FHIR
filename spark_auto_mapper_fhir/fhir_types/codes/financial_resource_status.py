...
class FhirFinancialResourceStatusCode(AutoMapperDataTypeLiteral):
    """
    ...
    class classproperty(object):
        def __init__(self, f: Callable[..., 'FhirFinancialResourceStatusCode']) -> None:
            self.f: Callable[..., 'FhirFinancialResourceStatusCode'] = f

        def __get__(self, obj: Any,
                    owner: Type['FhirFinancialResourceStatusCode']) -> 'FhirFinancialResourceStatusCode':
            return self.f(owner)
