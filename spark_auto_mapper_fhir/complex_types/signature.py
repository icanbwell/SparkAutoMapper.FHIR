...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.signature_type_codes import SignatureTypeCodes
...
class Signature(FhirComplexTypeBase):
    ...
    def __init__(
        ...
        *,
        ...
        :param type: An indication of the reason that the entity signed this document. This may be
