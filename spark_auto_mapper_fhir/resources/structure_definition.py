...
from spark_fhir_schemas.r4.resources.structuredefinition import StructureDefinitionSchema
...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.definition_use_codes import DefinitionUseCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.structure_definition_kind import StructureDefinitionKindCode
    # abstract (boolean)
    # context (StructureDefinition.Context)
    from spark_auto_mapper_fhir.backbone_elements.structure_definition_context import StructureDefinitionContext
    # contextInvariant (string)
    # type_ (uri)
    # baseDefinition (canonical)
    from spark_auto_mapper_fhir.fhir_types.canonical import FhirCanonical
    # derivation (TypeDerivationRule)
    from spark_auto_mapper_fhir.value_sets.type_derivation_rule import TypeDerivationRuleCode
    # snapshot (StructureDefinition.Snapshot)
    from spark_auto_mapper_fhir.backbone_elements.structure_definition_snapshot import StructureDefinitionSnapshot
    # differential (StructureDefinition.Differential)
    from spark_auto_mapper_fhir.backbone_elements.structure_definition_differential import StructureDefinitionDifferential
