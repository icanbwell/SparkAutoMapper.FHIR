...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.structure_definition_keyword import StructureDefinitionKeyword
    ...
    from spark_auto_mapper_fhir.complex_types.type_derivation_rule import TypeDerivationRule
