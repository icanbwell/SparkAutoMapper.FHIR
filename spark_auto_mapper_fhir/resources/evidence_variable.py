...
from spark_fhir_schemas.r4.resources.evidencevariable import EvidenceVariableSchema
...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.evidence_variable_type import EvidenceVariableTypeCode
    # characteristic (EvidenceVariable.Characteristic)
    from spark_auto_mapper_fhir.backbone_elements.evidence_variable_characteristic import EvidenceVariableCharacteristic
...
class EvidenceVariable(FhirResourceBase):
    ...
    different servers.
        :param identifier: A formal identifier that is used to identify this evidence variable when it is
    ...
    variable instances.
        :param jurisdiction: A legal or geographic region in which the evidence variable is intended to be
    used.
    ...
    periodically after approval but does not change the original approval date.
        :param effectivePeriod: The period during which the evidence variable content was or is planned to be
    in active use.
    ...
    bibliographic references.
        :param type_: The type of evidence element, a population, an exposure, or an outcome.
        :param characteristic: A characteristic that defines the members of the evidence element. Multiple
    ...
    def get_schema(
        ...
        return EvidenceVariableSchema.get_schema(include_extension=include_extension)
