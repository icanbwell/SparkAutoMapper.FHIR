...
from spark_fhir_schemas.r4.resources.coverageeligibilityrequest import CoverageEligibilityRequestSchema
...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.eligibility_request_purpose import EligibilityRequestPurposeCode
    # patient (Reference)
    ...
    from spark_auto_mapper_fhir.backbone_elements.coverage_eligibility_request_supporting_info import CoverageEligibilityRequestSupportingInfo
    # insurance (CoverageEligibilityRequest.Insurance)
    from spark_auto_mapper_fhir.backbone_elements.coverage_eligibility_request_insurance import CoverageEligibilityRequestInsurance
    # item (CoverageEligibilityRequest.Item)
    from spark_auto_mapper_fhir.backbone_elements.coverage_eligibility_request_item import CoverageEligibilityRequestItem
...
class CoverageEligibilityRequest(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        provider: Optional[Reference [Union[Practitioner, PractitionerRole, Organization]]] = None,
        insurer: Reference [Union[Organization]],
        facility: Optional[Reference [Union[Location]]] = None,
        supportingInfo: Optional[FhirList[CoverageEligibilityRequestSupportingInfo ]] = None,
    ...
    def get_schema(
        ...
        return CoverageEligibilityRequestSchema.get_schema(include_extension=include_extension)
