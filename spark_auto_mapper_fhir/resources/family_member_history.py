...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.family_history_status import FamilyHistoryStatusCode
    # dataAbsentReason (CodeableConcept)
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for dataAbsentReason
    from spark_auto_mapper_fhir.value_sets.family_history_absent_reason import FamilyHistoryAbsentReasonCode
...
class FamilyMemberHistory(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        dataAbsentReason: Optional[CodeableConcept[FamilyHistoryAbsentReasonCode] ] = None,
