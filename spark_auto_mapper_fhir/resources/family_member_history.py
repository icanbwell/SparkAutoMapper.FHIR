...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.family_history_absent_reason import FamilyHistoryAbsentReason
    ...
    from spark_auto_mapper_fhir.value_sets.administrative_gender import AdministrativeGender
