...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.familyhistoryabsentreason import Familyhistoryabsentreason
    ...
    from spark_auto_mapper_fhir.value_sets.administrativegender import Administrativegender
