...
from spark_fhir_schemas.r4.resources.substancenucleicacid import SubstanceNucleicAcidSchema
...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    from spark_auto_mapper_fhir.backbone_elements.substance_nucleic_acid_subunit import SubstanceNucleicAcidSubunit
...
class SubstanceNucleicAcid(FhirResourceBase):
    ...
    def get_schema(
        ...
        return SubstanceNucleicAcidSchema.get_schema(include_extension=include_extension)
