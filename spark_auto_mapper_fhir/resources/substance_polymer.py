...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.substance_polymer_monomer_set import SubstancePolymerMonomerSet
    # repeat (SubstancePolymer.Repeat)
    from spark_auto_mapper_fhir.backbone_elements.substance_polymer_repeat import SubstancePolymerRepeat
...
class SubstancePolymer(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        copolymerConnectivity: Optional[FhirList[CodeableConcept[GenericTypeCode] ]] = None,
