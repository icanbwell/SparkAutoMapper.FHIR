...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.immunization_status_reason_codes import ImmunizationStatusReasonCodes
    ...
    from spark_auto_mapper_fhir.value_sets.immunization_origin_codes import ImmunizationOriginCodes
    ...
    from spark_auto_mapper_fhir.value_sets.codes_for_immunization_site_of_administration import CodesForImmunizationSiteOfAdministration
    # End Import for CodeableConcept for site
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for route
    from spark_auto_mapper_fhir.value_sets.immunization_route_codes import ImmunizationRouteCodes
    ...
    from spark_auto_mapper_fhir.value_sets.immunization_reason_codes import ImmunizationReasonCodes
...
class Immunization(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        site: Optional[CodeableConcept[CodesForImmunizationSiteOfAdministration] ] = None,
