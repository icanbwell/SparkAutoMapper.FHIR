...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.immunization_status_codes import ImmunizationStatusCodesCode
    # statusReason (CodeableConcept)
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for statusReason
    from spark_auto_mapper_fhir.value_sets.immunization_status_reason_codes import ImmunizationStatusReasonCodesCode
    # End Import for CodeableConcept for statusReason
    # vaccineCode (CodeableConcept)
    # Import for CodeableConcept for vaccineCode
    from spark_auto_mapper_fhir.value_sets.vaccine_administered_value_set import VaccineAdministeredValueSetCode
    ...
    from spark_auto_mapper_fhir.value_sets.immunization_origin_codes import ImmunizationOriginCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.codes_for_immunization_site_of_administration import CodesForImmunizationSiteOfAdministrationCode
    # End Import for CodeableConcept for site
    # route (CodeableConcept)
    # Import for CodeableConcept for route
    from spark_auto_mapper_fhir.value_sets.immunization_route_codes import ImmunizationRouteCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.immunization_reason_codes import ImmunizationReasonCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.immunization_subpotent_reason import ImmunizationSubpotentReasonCode
    ...
    from spark_auto_mapper_fhir.value_sets.immunization_program_eligibility import ImmunizationProgramEligibilityCode
    # End Import for CodeableConcept for programEligibility
    # fundingSource (CodeableConcept)
    # Import for CodeableConcept for fundingSource
    from spark_auto_mapper_fhir.value_sets.immunization_funding_source import ImmunizationFundingSourceCode
...
class Immunization(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        statusReason: Optional[CodeableConcept[ImmunizationStatusReasonCodesCode] ] = None,
        ...
        site: Optional[CodeableConcept[CodesForImmunizationSiteOfAdministrationCode] ] = None,
        ...
        reasonCode: Optional[FhirList[CodeableConcept[ImmunizationReasonCodesCode] ]] = None,
        ...
        subpotentReason: Optional[FhirList[CodeableConcept[ImmunizationSubpotentReasonCode] ]] = None,
        education: Optional[FhirList[ImmunizationEducation ]] = None,
        programEligibility: Optional[FhirList[CodeableConcept[ImmunizationProgramEligibilityCode] ]] = None,
