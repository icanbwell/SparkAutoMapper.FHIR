...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.immunization_status_reason import (
    ...
    from spark_auto_mapper_fhir.complex_types.immunization_report_origin import (
    ...
    from spark_auto_mapper_fhir.complex_types.immunization_route import (
        ImmunizationRoute,
    )
    ...
    from spark_auto_mapper_fhir.complex_types.immunization_reason import (
        ImmunizationReason,
    )
    from spark_auto_mapper_fhir.complex_types.reference import Reference
    ...
    from spark_auto_mapper_fhir.complex_types.program_eligibility import (
        ProgramEligibility,
    )
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    ...
    def __init__(
        ...
        *,
        ...
        programEligibility: Optional[
            FhirList[CodeableConcept[ProgramEligibility]]
        ] = None,
