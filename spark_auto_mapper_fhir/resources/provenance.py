...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.provenance_reason import ProvenanceReason
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for activity
    from spark_auto_mapper_fhir.complex_types.provenance_activity import ProvenanceActivity
...
class Provenance(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        reason: Optional[FhirList[CodeableConcept[ProvenanceReason] ]] = None,
        activity: Optional[CodeableConcept[ProvenanceActivity] ] = None,
