...
from spark_fhir_schemas.r4.resources.medicinalproductpackaged import MedicinalProductPackagedSchema
...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.resources.medicinal_product_authorization import MedicinalProductAuthorization
    from spark_auto_mapper_fhir.complex_types.reference import Reference
    # Imports for References for manufacturer
    from spark_auto_mapper_fhir.resources.organization import Organization
    from spark_auto_mapper_fhir.backbone_elements.medicinal_product_packaged_batch_identifier import MedicinalProductPackagedBatchIdentifier
...
class MedicinalProductPackaged(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        marketingAuthorization: Optional[Reference [Union[MedicinalProductAuthorization]]] = None,
        manufacturer: Optional[FhirList[Reference [Union[Organization]]]] = None,
        batchIdentifier: Optional[FhirList[MedicinalProductPackagedBatchIdentifier ]] = None,
    ...
    def get_schema(
        ...
        return MedicinalProductPackagedSchema.get_schema(include_extension=include_extension)
