...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.search_modifier_code import SearchModifierCodeCode
    # chain (string)
    # component (SearchParameter.Component)
    from spark_auto_mapper_fhir.backbone_elements.search_parameter_component import SearchParameterComponent
