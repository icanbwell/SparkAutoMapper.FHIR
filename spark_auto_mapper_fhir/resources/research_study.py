...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.research_study_status import ResearchStudyStatusCode
...
class ResearchStudy(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        condition: Optional[FhirList[CodeableConcept[Condition_or_Problem_or_DiagnosisCodesCode] ]] = None,
