...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.communication_not_done_reason import CommunicationNotDoneReasonCode
    ...
    from spark_auto_mapper_fhir.value_sets.communication_topic import CommunicationTopicCode
