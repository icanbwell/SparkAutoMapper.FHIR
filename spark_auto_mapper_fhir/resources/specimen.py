...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.specimen_collection import SpecimenCollection
    from spark_auto_mapper_fhir.backbone_elements.specimen_processing import SpecimenProcessing
    from spark_auto_mapper_fhir.backbone_elements.specimen_container import SpecimenContainer
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for condition
    from spark_auto_mapper_fhir.complex_types.specimen_condition import SpecimenCondition
...
class Specimen(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        subject: Optional[Reference [Union[Patient, Group, Device, Substance, Location]]] = None,
        ...
        condition: Optional[FhirList[CodeableConcept[SpecimenCondition] ]] = None,
