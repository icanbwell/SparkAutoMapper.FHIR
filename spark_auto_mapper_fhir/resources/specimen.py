...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.specimen_type import SpecimenType
    ...
    from spark_auto_mapper_fhir.complex_types.specimen_condition import (
        SpecimenCondition,
    )
...
class Specimen(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        type: Optional[CodeableConcept[SpecimenType]] = None,
        subject: Optional[
