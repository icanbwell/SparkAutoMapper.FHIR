...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.procedure_not_performed_reason_snomed_ct_ import ProcedureNotPerformedReason_SNOMED_CT_
    # End Import for CodeableConcept for statusReason
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for category
    from spark_auto_mapper_fhir.value_sets.procedure_category_codes_snomedct_ import ProcedureCategoryCodes_SNOMEDCT_
    ...
    from spark_auto_mapper_fhir.value_sets.procedure_outcome_codes_snomedct_ import ProcedureOutcomeCodes_SNOMEDCT_
    ...
    from spark_auto_mapper_fhir.value_sets.procedure_follow_up_codes_snomedct_ import ProcedureFollowUpCodes_SNOMEDCT_
...
class Procedure(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        status: EventStatus ,
        statusReason: Optional[CodeableConcept[ProcedureNotPerformedReason_SNOMED_CT_] ] = None,
        ...
        followUp: Optional[FhirList[CodeableConcept[ProcedureFollowUpCodes_SNOMEDCT_] ]] = None,
