...
from spark_auto_mapper_fhir import backbone_elements
...
from spark_auto_mapper_fhir.fhir_types import uri
...
from spark_auto_mapper_fhir.resources.measure import Measure
...
class Procedure(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        instantiatesCanonical: Optional[FhirCanonical[Union[PlanDefinition,'ActivityDefinition',Measure,'OperationDefinition',Questionnaire]]]=None,
        instantiatesUri: Optional[FhirList[uri]],
        basedOn: Optional[FhirList[Union[CarePlan,ServiceRequest]]]=None,
        partOf: Optional[FhirList[Union[Procedure,Observation,MedicationAdministration]]]=None,
        category: Optional[CodeableConcept[SnoMedCode]]=None,
        code: Optional[CodeableConcept[SNOMEDCTProcedureCode]]=None,
        performed: Optional[] = None,                                                           ## Investigate
        ...
        reasonCode: Optional[FhirList[CodeableConcept[SN]] = None,
        ...
        usedReference: Optional[FhirList[Reference[Device,MedicationAdministrationcation,]]] = None,
        usedCode: Optional[FhirList[CodeableConcept]] = None,
        ...
        super().__init__(
            ...
            code=code,
            encounter=encounter,
            performed=performed,                        # Do more investigation
            recorder=recorder,
            asserter=asserter,
            performer=performer,
            location=location,
