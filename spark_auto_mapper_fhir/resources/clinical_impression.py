...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.clinical_impression_status import ClinicalImpressionStatusCode
    ...
    from spark_auto_mapper_fhir.value_sets.clinical_impression_prognosis import ClinicalImpressionPrognosisCode
...
class ClinicalImpression(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        prognosisCodeableConcept: Optional[FhirList[CodeableConcept[ClinicalImpressionPrognosisCode] ]] = None,
