...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.clinical_impression_status_reason import (
        ClinicalImpressionStatusReason,
    )
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept

    # Import for CodeableConcept for code
    from spark_auto_mapper_fhir.complex_types.clinical_impression_code import (
    ...
    from spark_auto_mapper_fhir.complex_types.clinical_impression_prognosis import (
