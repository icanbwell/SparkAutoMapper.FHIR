...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.request_group_action import RequestGroupAction
...
class RequestGroup(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        author: Optional[Reference [Union[Device, Practitioner, PractitionerRole]]] = None,
