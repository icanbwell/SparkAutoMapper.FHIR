...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.task_restriction import TaskRestriction
...
class Task(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        businessStatus: Optional[CodeableConcept[ACMECholCodesBloodCode] ] = None,
        intent: TaskIntent ,
        ...
        requester: Optional[Reference [Union[Device, Organization, Patient, Practitioner, PractitionerRole, RelatedPerson]]] = None,
        performerType: Optional[FhirList[CodeableConcept[ProcedurePerformerRoleCodesCode] ]] = None,
        ...
        reasonCode: Optional[CodeableConcept[ACMECholCodesBloodCode] ] = None,
