...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.task_business_status import TaskBusinessStatus
    ...
    from spark_auto_mapper_fhir.resources.resource import Resource
    from spark_auto_mapper_fhir.complex_types.reference import Reference
    # Imports for References for for
    from spark_auto_mapper_fhir.resources.resource import Resource
    from spark_auto_mapper_fhir.complex_types.reference import Reference
    ...
    from spark_auto_mapper_fhir.complex_types.task_performer_type import TaskPerformerType
    from spark_auto_mapper_fhir.complex_types.reference import Reference
...
class Task(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        for: Optional[Reference [Union[Resource]]] = None,
    ...
    requests.
        ...
        :param for: The entity who benefits from the performance of the service specified in the
