...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.composite_measure_scoring import CompositeMeasureScoringCode
    ...
    from spark_auto_mapper_fhir.value_sets.measure_improvement_notation import MeasureImprovementNotationCode
