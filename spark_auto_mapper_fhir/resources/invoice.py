...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.invoice_participant import InvoiceParticipant
    from spark_auto_mapper_fhir.complex_types.reference import Reference
    ...
    from spark_auto_mapper_fhir.backbone_elements.invoice_line_item import InvoiceLineItem
...
class Invoice(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        recipient: Optional[Reference [Union[Organization, Patient, RelatedPerson]]] = None,
    ...
    superseded by corrected invoice etc.).
        :param type: Type of Invoice depending on domain, realm an usage (e.g. internal/external,
    dental, preliminary).
