...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.medicationrequest_status import MedicationrequestStatusCode
    # statusReason (CodeableConcept)
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for statusReason
    from spark_auto_mapper_fhir.value_sets.medication_request_status_reason_codes import MedicationRequestStatusReasonCodesCode
    # End Import for CodeableConcept for statusReason
    # intent (medicationRequest Intent)
    from spark_auto_mapper_fhir.value_sets.medication_request_intent import MedicationRequestIntentCode
    # category (CodeableConcept)
    # Import for CodeableConcept for category
    from spark_auto_mapper_fhir.value_sets.medication_request_category_codes import MedicationRequestCategoryCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.snomedct_medication_codes import SNOMEDCTMedicationCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.procedure_performer_role_codes import ProcedurePerformerRoleCodesCode
    # End Import for CodeableConcept for performerType
    # recorder (Reference)
    # Imports for References for recorder
    # reasonCode (CodeableConcept)
    # Import for CodeableConcept for reasonCode
    from spark_auto_mapper_fhir.value_sets.condition_or__problem_or__diagnosis_codes import Condition_or_Problem_or_DiagnosisCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.medication_request_course_of_therapy_codes import MedicationRequestCourseOfTherapyCodesCode
...
class MedicationRequest(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        statusReason: Optional[CodeableConcept[MedicationRequestStatusReasonCodesCode] ] = None,
        intent: MedicationRequestIntentCode ,
        category: Optional[FhirList[CodeableConcept[MedicationRequestCategoryCodesCode] ]] = None,
        ...
        reportedReference: Optional[Reference [Union[Patient, Practitioner, PractitionerRole, RelatedPerson, Organization]]] = None,
        medicationCodeableConcept: Optional[CodeableConcept[SNOMEDCTMedicationCodesCode] ] = None,
        ...
        performerType: Optional[CodeableConcept[ProcedurePerformerRoleCodesCode] ] = None,
        recorder: Optional[Reference [Union[Practitioner, PractitionerRole]]] = None,
        reasonCode: Optional[FhirList[CodeableConcept[Condition_or_Problem_or_DiagnosisCodesCode] ]] = None,
        ...
        courseOfTherapyType: Optional[CodeableConcept[MedicationRequestCourseOfTherapyCodesCode] ] = None,
