...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.medication_request_status_reason import (
    ...
    from spark_auto_mapper_fhir.complex_types.medication_request_category import (
    ...
    from spark_auto_mapper_fhir.complex_types.medication_request_performer_type import (
    ...
    from spark_auto_mapper_fhir.complex_types.medication_request_reason import (
    ...
    from spark_auto_mapper_fhir.complex_types.medication_request_course_of_therapy import (
    ...
    def __init__(
        ...
        *,
        ...
        courseOfTherapyType: Optional[
            CodeableConcept[MedicationRequestCourseOfTherapy]
        ] = None,
