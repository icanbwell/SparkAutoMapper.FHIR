...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.medication_request_status_reason_codes import MedicationRequestStatusReasonCodes
    ...
    from spark_auto_mapper_fhir.value_sets.medication_request_category_codes import MedicationRequestCategoryCodes
    ...
    from spark_auto_mapper_fhir.value_sets.procedure_performer_role_codes import ProcedurePerformerRoleCodes
    ...
    from spark_auto_mapper_fhir.value_sets.medication_request_course_of_therapy_codes import MedicationRequestCourseOfTherapyCodes
