...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.audit_event_type import AuditEventType
    from spark_auto_mapper_fhir.complex_types.coding import Coding

    # Import for CodeableConcept for subtype
    from spark_auto_mapper_fhir.complex_types.audit_event_sub_type import (
        AuditEventSubType,
    )
    ...
    from spark_auto_mapper_fhir.complex_types.audit_purpose_of_use import (
        AuditPurposeOfUse,
    )
