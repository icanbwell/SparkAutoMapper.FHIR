...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.audit_event_sub_type import AuditEventSubType
    ...
    from spark_auto_mapper_fhir.complex_types.audit_event_outcome import AuditEventOutcome
    from spark_auto_mapper_fhir.complex_types.string import FhirString
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for purposeOfEvent
    from spark_auto_mapper_fhir.complex_types.audit_purpose_of_use import AuditPurposeOfUse
    from spark_auto_mapper_fhir.backbone_elements.audit_event_agent import AuditEventAgent
    from spark_auto_mapper_fhir.backbone_elements.audit_event_source import AuditEventSource
    from spark_auto_mapper_fhir.backbone_elements.audit_event_entity import AuditEventEntity
...
class AuditEvent(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        type_: Coding ,
        subtype: Optional[FhirList[Coding[AuditEventSubType] ]] = None,
        action: Optional[AuditEventAction ] = None,
        period: Optional[Period ] = None,
        recorded: instant ,
        outcome: Optional[AuditEventOutcome ] = None,
        outcomeDesc: Optional[FhirString ] = None,
        purposeOfEvent: Optional[FhirList[CodeableConcept[AuditPurposeOfUse] ]] = None,
