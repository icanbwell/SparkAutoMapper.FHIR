...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.audit_event_id import AuditEventID
    # End Import for CodeableConcept for type
    from spark_auto_mapper_fhir.complex_types.coding import Coding
    # Import for CodeableConcept for subtype
    from spark_auto_mapper_fhir.value_sets.audit_event_sub__type import AuditEventSub_Type
...
class AuditEvent(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        :param type: Identifier for a family of the event.  For example, a menu item, program,
