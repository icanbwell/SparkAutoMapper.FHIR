...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.audit_event_sub__type import AuditEventSub_TypeCode
    # End Import for CodeableConcept for subtype
    # action (AuditEventAction)
    from spark_auto_mapper_fhir.value_sets.audit_event_action import AuditEventActionCode
    # period (Period)
    from spark_auto_mapper_fhir.complex_types.period import Period
    # recorded (instant)
    from spark_auto_mapper_fhir.fhir_types.instant import FhirInstant
    # outcome (AuditEventOutcome)
    from spark_auto_mapper_fhir.value_sets.audit_event_outcome import AuditEventOutcomeCode
    # outcomeDesc (string)
