...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.encounter_reason_codes import EncounterReasonCodesCode
...
class Encounter(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        reasonCode: Optional[FhirList[CodeableConcept[EncounterReasonCodesCode] ]] = None,
