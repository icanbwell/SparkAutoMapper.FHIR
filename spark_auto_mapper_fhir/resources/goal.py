...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.goal_lifecycle_status import GoalLifecycleStatusCode
    # achievementStatus (CodeableConcept)
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for achievementStatus
    from spark_auto_mapper_fhir.value_sets.goal_achievement_status import GoalAchievementStatusCode
...
class Goal(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        outcomeCode: Optional[FhirList[CodeableConcept[SNOMEDCTClinicalFindingsCode] ]] = None,
