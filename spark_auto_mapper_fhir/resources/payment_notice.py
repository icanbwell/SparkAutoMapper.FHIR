...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.resources.payment_reconciliation import PaymentReconciliation
    # paymentDate (date)
    # payee (Reference)
    ...
    from spark_auto_mapper_fhir.value_sets.payment_status_codes import PaymentStatusCodesCode
