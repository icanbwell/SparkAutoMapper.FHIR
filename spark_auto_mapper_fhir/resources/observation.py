...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.observation_interpretation_codes import ObservationInterpretationCodes
...
class Observation(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        interpretation: Optional[FhirList[CodeableConcept[ObservationInterpretationCodes] ]] = None,
