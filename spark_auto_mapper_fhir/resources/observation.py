...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.observation_category import ObservationCategory
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    ...
    from spark_auto_mapper_fhir.complex_types.observation_value_absent_reason import ObservationValueAbsentReason
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for interpretation
    from spark_auto_mapper_fhir.complex_types.observation_interpretation import ObservationInterpretation
    ...
    from spark_auto_mapper_fhir.complex_types.observation_method import ObservationMethod
    from spark_auto_mapper_fhir.complex_types.reference import Reference
...
class Observation(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        dataAbsentReason: Optional[CodeableConcept[ObservationValueAbsentReason] ] = None,
        interpretation: Optional[FhirList[CodeableConcept[ObservationInterpretation] ]] = None,
