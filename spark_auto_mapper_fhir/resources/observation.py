...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.observation_status import ObservationStatusCode
    ...
    from spark_auto_mapper_fhir.value_sets.data_absent_reason import DataAbsentReasonCode
    # End Import for CodeableConcept for dataAbsentReason
    # interpretation (CodeableConcept)
    # Import for CodeableConcept for interpretation
    from spark_auto_mapper_fhir.value_sets.observation_interpretation_codes import ObservationInterpretationCodesCode
...
class Observation(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        interpretation: Optional[FhirList[CodeableConcept[ObservationInterpretationCodesCode] ]] = None,
