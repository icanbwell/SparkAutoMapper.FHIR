...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.measure_report_status import MeasureReportStatusCode
    # type_ (MeasureReportType)
    from spark_auto_mapper_fhir.value_sets.measure_report_type import MeasureReportTypeCode
    # measure (canonical)
