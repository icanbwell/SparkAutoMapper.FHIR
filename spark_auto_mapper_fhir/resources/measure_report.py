...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.measure_report_status import MeasureReportStatus
    from spark_auto_mapper_fhir.complex_types.measure_report_type import MeasureReportType
    ...
    from spark_auto_mapper_fhir.complex_types.measure_improvement_notation import MeasureImprovementNotation
    from spark_auto_mapper_fhir.backbone_elements.measure_report_group import MeasureReportGroup
    from spark_auto_mapper_fhir.complex_types.reference import Reference
...
class MeasureReport(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        measure: canonical ,
        subject: Optional[Reference [Union[Patient, Practitioner, PractitionerRole, Location, Device, RelatedPerson, Group]]] = None,
        date: Optional[FhirDateTime ] = None,
        reporter: Optional[Reference [Union[Practitioner, PractitionerRole, Location, Organization]]] = None,
        period: Period ,
        improvementNotation: Optional[CodeableConcept[MeasureImprovementNotation] ] = None,
