...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.structure_map_structure import StructureMapStructure
    # import_ (canonical)
    from spark_auto_mapper_fhir.fhir_types.canonical import FhirCanonical
    # group (StructureMap.Group)
    from spark_auto_mapper_fhir.backbone_elements.structure_map_group import StructureMapGroup
