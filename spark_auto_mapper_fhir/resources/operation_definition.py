...
from spark_fhir_schemas.r4.resources.operationdefinition import OperationDefinitionSchema
...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.operation_definition_parameter import OperationDefinitionParameter
    # overload (OperationDefinition.Overload)
    from spark_auto_mapper_fhir.backbone_elements.operation_definition_overload import OperationDefinitionOverload
