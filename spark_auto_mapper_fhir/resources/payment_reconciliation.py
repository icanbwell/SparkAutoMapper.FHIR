...
from spark_fhir_schemas.r4.resources.paymentreconciliation import PaymentReconciliationSchema
...
class PaymentReconciliation(FhirResourceBase):
    ...
    def get_schema(
        ...
        return PaymentReconciliationSchema.get_schema(include_extension=include_extension)
