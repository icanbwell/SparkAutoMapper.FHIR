...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.adverse_event_category import AdverseEventCategory
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    ...
    from spark_auto_mapper_fhir.complex_types.adverse_event_seriousness import AdverseEventSeriousness
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for severity
    from spark_auto_mapper_fhir.complex_types.adverse_event_severity import AdverseEventSeverity
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for outcome
    from spark_auto_mapper_fhir.complex_types.adverse_event_outcome import AdverseEventOutcome
    from spark_auto_mapper_fhir.complex_types.reference import Reference
