...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.adverse_event_actuality import AdverseEventActualityCode
    # category (CodeableConcept)
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for category
    from spark_auto_mapper_fhir.value_sets.adverse_event_category import AdverseEventCategoryCode
    ...
    from spark_auto_mapper_fhir.value_sets.adverse_event_seriousness import AdverseEventSeriousnessCode
    # End Import for CodeableConcept for seriousness
    # severity (CodeableConcept)
    # Import for CodeableConcept for severity
    from spark_auto_mapper_fhir.value_sets.adverse_event_severity import AdverseEventSeverityCode
    # End Import for CodeableConcept for severity
    # outcome (CodeableConcept)
    # Import for CodeableConcept for outcome
    from spark_auto_mapper_fhir.value_sets.adverse_event_outcome import AdverseEventOutcomeCode
    ...
    from spark_auto_mapper_fhir.backbone_elements.adverse_event_suspect_entity import AdverseEventSuspectEntity
...
class AdverseEvent(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        contributor: Optional[FhirList[Reference [Union[Practitioner, PractitionerRole, Device]]]] = None,
        suspectEntity: Optional[FhirList[AdverseEventSuspectEntity ]] = None,
        subjectMedicalHistory: Optional[FhirList[Reference [Union[Condition, Observation, AllergyIntolerance, FamilyMemberHistory, Immunization, Procedure, Media, DocumentReference]]]] = None,
        referenceDocument: Optional[FhirList[Reference [Union[DocumentReference]]]] = None,
