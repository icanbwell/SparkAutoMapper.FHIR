...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.condition_clinical_status import ConditionClinicalStatus
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for verificationStatus
    from spark_auto_mapper_fhir.complex_types.condition_verification_status import ConditionVerificationStatus
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for category
    from spark_auto_mapper_fhir.complex_types.condition_category import ConditionCategory
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for severity
    from spark_auto_mapper_fhir.complex_types.condition_severity import ConditionSeverity
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for code
    from spark_auto_mapper_fhir.complex_types.condition_kind import ConditionKind
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
...
class Condition(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        clinicalStatus: Optional[CodeableConcept[ConditionClinicalStatus] ] = None,
        verificationStatus: Optional[CodeableConcept[ConditionVerificationStatus] ] = None,
        category: Optional[FhirList[CodeableConcept[ConditionCategory] ]] = None,
        severity: Optional[CodeableConcept[ConditionSeverity] ] = None,
        code: Optional[CodeableConcept[ConditionKind] ] = None,
