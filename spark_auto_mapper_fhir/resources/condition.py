...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.condition_clinical_status import (
        ConditionClinicalStatus,
    )
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept

    # Import for CodeableConcept for verificationStatus
    from spark_auto_mapper_fhir.complex_types.condition_verification_status import (
        ConditionVerificationStatus,
    )
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept

    # Import for CodeableConcept for category
    from spark_auto_mapper_fhir.complex_types.condition_category import (
        ConditionCategory,
    )
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept

    # Import for CodeableConcept for severity
    from spark_auto_mapper_fhir.complex_types.condition_severity import (
        ConditionSeverity,
    )
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    ...
    def __init__(
        ...
        *,
        ...
        verificationStatus: Optional[
            CodeableConcept[ConditionVerificationStatus]
        ] = None,
