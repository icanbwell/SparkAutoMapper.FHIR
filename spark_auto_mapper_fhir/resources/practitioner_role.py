...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.practitioner_role import PractitionerRole
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for specialty
    from spark_auto_mapper_fhir.complex_types.practitioner_specialty import PractitionerSpecialty
    from spark_auto_mapper_fhir.complex_types.reference import Reference
    ...
    from spark_auto_mapper_fhir.backbone_elements.practitioner_role_available_time import PractitionerRoleAvailableTime
    from spark_auto_mapper_fhir.backbone_elements.practitioner_role_not_available import PractitionerRoleNotAvailable
...
class PractitionerRole(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        specialty: Optional[FhirList[CodeableConcept[PractitionerSpecialty] ]] = None,
