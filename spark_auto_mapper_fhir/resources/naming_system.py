...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.naming_system_type import NamingSystemTypeCode
    # date (dateTime)
    # publisher (string)
    ...
    from spark_auto_mapper_fhir.backbone_elements.naming_system_unique_id import NamingSystemUniqueId
