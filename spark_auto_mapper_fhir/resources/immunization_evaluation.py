...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.evaluation_target_disease import EvaluationTargetDisease
    from spark_auto_mapper_fhir.complex_types.reference import Reference
    ...
    from spark_auto_mapper_fhir.complex_types.evaluation_dose_status import EvaluationDoseStatus
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for doseStatusReason
    from spark_auto_mapper_fhir.complex_types.evaluation_dose_status_reason import EvaluationDoseStatusReason
...
class ImmunizationEvaluation(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        doseStatusReason: Optional[FhirList[CodeableConcept[EvaluationDoseStatusReason] ]] = None,
