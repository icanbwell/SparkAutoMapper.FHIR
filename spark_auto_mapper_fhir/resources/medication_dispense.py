...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.medication_dispense_status_codes import MedicationDispenseStatusCodesCode
    # statusReasonCodeableConcept (CodeableConcept)
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for statusReasonCodeableConcept
    from spark_auto_mapper_fhir.value_sets.medication_dispense_status_reason_codes import MedicationDispenseStatusReasonCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.act_pharmacy_supply_type import ActPharmacySupplyType
...
class MedicationDispense(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        statusReasonCodeableConcept: Optional[CodeableConcept[MedicationDispenseStatusReasonCodesCode] ] = None,
