...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.medication_dispense_category import (
    ...
    from spark_auto_mapper_fhir.complex_types.medication_dispense_type import (
...
class MedicationDispense(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        status: code,
        category: Optional[CodeableConcept[MedicationDispenseCategory]] = None,
        ...
        type: Optional[CodeableConcept[MedicationDispenseType]] = None,
        ...
        medication will be given.
            ...
            :param type: Indicates the type of dispensing event that is performed. For example, Trial
