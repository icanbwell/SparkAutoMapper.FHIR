...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.fhir_document_type_codes import FHIRDocumentTypeCodes
    ...
    from spark_auto_mapper_fhir.complex_types.v_confidentiality_classification import vConfidentialityClassification
    from spark_auto_mapper_fhir.backbone_elements.composition_attester import CompositionAttester
    from spark_auto_mapper_fhir.complex_types.reference import Reference
    # Imports for References for custodian
    from spark_auto_mapper_fhir.resources.organization import Organization
    from spark_auto_mapper_fhir.backbone_elements.composition_relates_to import CompositionRelatesTo
    from spark_auto_mapper_fhir.backbone_elements.composition_event import CompositionEvent
    from spark_auto_mapper_fhir.backbone_elements.composition_section import CompositionSection
...
class Composition(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        date: FhirDateTime ,
        author: FhirList[Reference [Union[Practitioner, PractitionerRole, Device, Patient, RelatedPerson, Organization]]],
        title: FhirString ,
    ...
    the clinical standing of the document.
        :param type: Specifies the particular kind of composition (e.g. History and Physical,
