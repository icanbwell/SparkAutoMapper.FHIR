...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.organization_affiliation import OrganizationAffiliation
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for specialty
    from spark_auto_mapper_fhir.complex_types.organization_specialty import OrganizationSpecialty
    from spark_auto_mapper_fhir.complex_types.reference import Reference
...
class OrganizationAffiliation(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        code: Optional[FhirList[CodeableConcept[OrganizationAffiliation] ]] = None,
        specialty: Optional[FhirList[CodeableConcept[OrganizationSpecialty] ]] = None,
