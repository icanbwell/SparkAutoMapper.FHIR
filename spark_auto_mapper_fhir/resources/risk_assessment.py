...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.risk_assessment_method import RiskAssessmentMethod
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    from spark_auto_mapper_fhir.complex_types.reference import Reference
    ...
    from spark_auto_mapper_fhir.resources.resource import Resource
    from spark_auto_mapper_fhir.backbone_elements.risk_assessment_prediction import RiskAssessmentPrediction
...
class RiskAssessment(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        performer: Optional[Reference [Union[Practitioner, PractitionerRole, Device]]] = None,
