...
from spark_fhir_schemas.r4.resources.substancesourcematerial import SubstanceSourceMaterialSchema
...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.string import FhirString
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    from spark_auto_mapper_fhir.backbone_elements.substance_source_material_fraction_description import SubstanceSourceMaterialFractionDescription
    from spark_auto_mapper_fhir.backbone_elements.substance_source_material_organism import SubstanceSourceMaterialOrganism
    from spark_auto_mapper_fhir.backbone_elements.substance_source_material_part_description import SubstanceSourceMaterialPartDescription
...
class SubstanceSourceMaterial(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        fractionDescription: Optional[FhirList[SubstanceSourceMaterialFractionDescription ]] = None,
        organism: Optional[SubstanceSourceMaterialOrganism ] = None,
        partDescription: Optional[FhirList[SubstanceSourceMaterialPartDescription ]] = None,
    ) -> None:
        """
    ...
    def get_schema(
        ...
        return SubstanceSourceMaterialSchema.get_schema(include_extension=include_extension)
