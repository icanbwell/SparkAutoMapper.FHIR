...
from spark_fhir_schemas.r4.resources.implementationguide import ImplementationGuideSchema
...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.implementation_guide_depends_on import ImplementationGuideDependsOn
    # global_ (ImplementationGuide.Global)
    from spark_auto_mapper_fhir.backbone_elements.implementation_guide_global import ImplementationGuideGlobal
    # definition (ImplementationGuide.Definition)
    from spark_auto_mapper_fhir.backbone_elements.implementation_guide_definition import ImplementationGuideDefinition
    # manifest (ImplementationGuide.Manifest)
    from spark_auto_mapper_fhir.backbone_elements.implementation_guide_manifest import ImplementationGuideManifest
