...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.appointment_status import AppointmentStatusCode
    # cancelationReason (CodeableConcept)
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for cancelationReason
    from spark_auto_mapper_fhir.value_sets.appointment_cancellation_reason import AppointmentCancellationReasonCode
...
class Appointment(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        cancelationReason: Optional[CodeableConcept[AppointmentCancellationReasonCode] ] = None,
