...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.care_plan_category import CarePlanCategoryCode
    ...
    from spark_auto_mapper_fhir.backbone_elements.care_plan_activity import CarePlanActivity
    # note (Annotation)
...
class CarePlan(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        author: Optional[Reference [Union[Patient, Practitioner, PractitionerRole, Device, RelatedPerson, Organization, CareTeam]]] = None,
        contributor: Optional[FhirList[Reference [Union[Patient, Practitioner, PractitionerRole, Device, RelatedPerson, Organization, CareTeam]]]] = None,
