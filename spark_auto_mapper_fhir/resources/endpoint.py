...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.endpoint_connection_type import EndpointConnectionTypeCode
    ...
    from spark_auto_mapper_fhir.value_sets.endpoint_payload_type import EndpointPayloadTypeCode
