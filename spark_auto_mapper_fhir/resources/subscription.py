...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.subscription_status import SubscriptionStatusCode
    ...
    from spark_auto_mapper_fhir.backbone_elements.subscription_channel import SubscriptionChannel
