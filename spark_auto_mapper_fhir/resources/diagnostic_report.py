...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.diagnostic_service_section import DiagnosticServiceSection
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for code
    from spark_auto_mapper_fhir.complex_types.diagnostic_report_codes import DiagnosticReportCodes
    from spark_auto_mapper_fhir.complex_types.reference import Reference
    ...
    from spark_auto_mapper_fhir.complex_types.adjunct_diagnosis import AdjunctDiagnosis
...
class DiagnosticReport(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        category: Optional[FhirList[CodeableConcept[DiagnosticServiceSection] ]] = None,
        code: CodeableConcept[DiagnosticReportCodes] ,
        ...
        conclusionCode: Optional[FhirList[CodeableConcept[AdjunctDiagnosis] ]] = None,
