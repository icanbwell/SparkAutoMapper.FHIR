...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.medication_route import MedicationRoute
...
class MedicationKnowledge(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        doseForm: Optional[CodeableConcept[MedicationForm] ] = None,
        ...
        intendedRoute: Optional[FhirList[CodeableConcept[MedicationRoute] ]] = None,
