...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.medication_knowledge_status_codes import MedicationKnowledgeStatusCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.snomedct_form_codes import SNOMEDCTFormCodesCode
...
class MedicationKnowledge(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        intendedRoute: Optional[FhirList[CodeableConcept[SNOMEDCTRouteCodesCode] ]] = None,
