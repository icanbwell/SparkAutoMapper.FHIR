...
from spark_fhir_schemas.r4.resources.medicinalproductauthorization import MedicinalProductAuthorizationSchema
...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.medicinal_product_authorization_jurisdictional_authorization import MedicinalProductAuthorizationJurisdictionalAuthorization
    # holder (Reference)
    ...
    from spark_auto_mapper_fhir.backbone_elements.medicinal_product_authorization_procedure import MedicinalProductAuthorizationProcedure
...
class MedicinalProductAuthorization(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        subject: Optional[Reference [Union[MedicinalProduct, MedicinalProductPackaged]]] = None,
        ...
        jurisdictionalAuthorization: Optional[FhirList[MedicinalProductAuthorizationJurisdictionalAuthorization ]] = None,
    ...
    def get_schema(
        ...
        return MedicinalProductAuthorizationSchema.get_schema(include_extension=include_extension)
