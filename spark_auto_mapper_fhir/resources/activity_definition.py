...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.activity_definition_type import ActivityDefinitionType
...
class ActivityDefinition(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        code: Optional[CodeableConcept[ActivityDefinitionType] ] = None,
