...
class ActivityDefinition(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        specimenRequirement: Optional[FhirList[Reference[SpecimenDefinition]]] = None,
        observationRequirement: Optional[
            FhirList[Reference[ObservationDefinition]]
        ] = None,
        ...
        used for genuine usage.
            ...
            :param date_: The date  (and optionally time) when the activity definition was published.
