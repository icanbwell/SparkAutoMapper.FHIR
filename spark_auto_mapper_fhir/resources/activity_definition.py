...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.publication_status import PublicationStatusCode
    ...
    from spark_auto_mapper_fhir.value_sets.request_resource_type import RequestResourceTypeCode
    # profile (canonical)
    ...
    from spark_auto_mapper_fhir.backbone_elements.activity_definition_participant import ActivityDefinitionParticipant
    ...
    from spark_auto_mapper_fhir.resources.observation_definition import ObservationDefinition
    ...
    from spark_auto_mapper_fhir.backbone_elements.activity_definition_dynamic_value import ActivityDefinitionDynamicValue
...
class ActivityDefinition(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        jurisdiction: Optional[FhirList[CodeableConcept[JurisdictionValueSetCode] ]] = None,
        ...
        specimenRequirement: Optional[FhirList[Reference [Union[SpecimenDefinition]]]] = None,
        observationRequirement: Optional[FhirList[Reference [Union[ObservationDefinition]]]] = None,
        observationResultRequirement: Optional[FhirList[Reference [Union[ObservationDefinition]]]] = None,
