...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.plan_definition_type import PlanDefinitionTypeCode
    ...
    from spark_auto_mapper_fhir.backbone_elements.plan_definition_goal import PlanDefinitionGoal
    # action (PlanDefinition.Action)
    from spark_auto_mapper_fhir.backbone_elements.plan_definition_action import PlanDefinitionAction
