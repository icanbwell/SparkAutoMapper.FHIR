...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.plan_definition_type import (
...
class PlanDefinition(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        servers.
            :param identifier: A formal identifier that is used to identify this plan definition when it is
        ...
        information about its content.
            :param type_: A high-level category for the plan definition that distinguishes the kinds of
        ...
        content.
            :param experimental: A Boolean value to indicate that this plan definition is authored for testing
        purposes (or education/evaluation/marketing) and is not intended to be used
        for genuine usage.
            :param date: The date  (and optionally time) when the plan definition was published. The
        ...
        definition instances.
            :param jurisdiction: A legal or geographic region in which the plan definition is intended to be
        used.
        ...
        periodically after approval but does not change the original approval date.
            :param effectivePeriod: The period during which the plan definition content was or is planned to be in
        active use.
