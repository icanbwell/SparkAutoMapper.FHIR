...
if TYPE_CHECKING:
    from spark_auto_mapper_fhir.backbone_elements.message_header_destination import MessageHeaderDestination
    ...
    from spark_auto_mapper_fhir.resources.practitioner import Practitioner
    from spark_auto_mapper_fhir.resources.practitioner_role import PractitionerRole
    from spark_auto_mapper_fhir.backbone_elements.message_header_source import MessageHeaderSource
    from spark_auto_mapper_fhir.complex_types.reference import Reference
    ...
    from spark_auto_mapper_fhir.complex_types.event_reason import EventReason
    from spark_auto_mapper_fhir.backbone_elements.message_header_response import MessageHeaderResponse
    from spark_auto_mapper_fhir.complex_types.reference import Reference
...
class MessageHeader(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        sender: Optional[Reference [Union[Practitioner, PractitionerRole, Organization]]] = None,
        ...
        responsible: Optional[Reference [Union[Practitioner, PractitionerRole, Organization]]] = None,
        reason: Optional[CodeableConcept[EventReason] ] = None,
