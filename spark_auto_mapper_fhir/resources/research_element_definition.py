...
from spark_fhir_schemas.r4.resources.researchelementdefinition import ResearchElementDefinitionSchema
...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.research_element_type import ResearchElementTypeCode
    ...
    from spark_auto_mapper_fhir.backbone_elements.research_element_definition_characteristic import ResearchElementDefinitionCharacteristic
...
class ResearchElementDefinition(FhirResourceBase):
    ...
    def get_schema(
        ...
        return ResearchElementDefinitionSchema.get_schema(include_extension=include_extension)
