...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.research_element_type import ResearchElementType
...
class ResearchElementDefinition(FhirResourceBase):
    ...
    ResearchElementDefinition.
        :param type: The type of research element, a population, an exposure, or an outcome.
