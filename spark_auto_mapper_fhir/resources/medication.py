...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.medication_formal_representation import MedicationFormalRepresentation
    ...
    from spark_auto_mapper_fhir.complex_types.medication_form import MedicationForm
    from spark_auto_mapper_fhir.complex_types.ratio import Ratio
    from spark_auto_mapper_fhir.backbone_elements.medication_ingredient import MedicationIngredient
    from spark_auto_mapper_fhir.backbone_elements.medication_batch import MedicationBatch
...
class Medication(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        code: Optional[CodeableConcept[MedicationFormalRepresentation] ] = None,
        status: Optional[MedicationStatusCodes ] = None,
        manufacturer: Optional[Reference [Union[Organization]]] = None,
        form: Optional[CodeableConcept[MedicationForm] ] = None,
