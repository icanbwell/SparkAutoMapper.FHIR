...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.claim_sub_type import ClaimSubType
    ...
    from spark_auto_mapper_fhir.complex_types.process_priority import ProcessPriority
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for fundsReserveRequested
    from spark_auto_mapper_fhir.complex_types.funds_reserve import FundsReserve
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    ...
    from spark_auto_mapper_fhir.resources.medication_request import MedicationRequest
    from spark_auto_mapper_fhir.backbone_elements.explanation_of_benefit_payee import ExplanationOfBenefitPayee
    from spark_auto_mapper_fhir.complex_types.reference import Reference
    ...
    from spark_auto_mapper_fhir.complex_types.claim_processing_codes import ClaimProcessingCodes
    from spark_auto_mapper_fhir.complex_types.string import FhirString
    from spark_auto_mapper_fhir.complex_types.string import FhirString
    from spark_auto_mapper_fhir.complex_types.period import Period
    from spark_auto_mapper_fhir.backbone_elements.explanation_of_benefit_care_team import ExplanationOfBenefitCareTeam
    from spark_auto_mapper_fhir.backbone_elements.explanation_of_benefit_supporting_info import ExplanationOfBenefitSupportingInfo
    from spark_auto_mapper_fhir.backbone_elements.explanation_of_benefit_diagnosis import ExplanationOfBenefitDiagnosis
    from spark_auto_mapper_fhir.backbone_elements.explanation_of_benefit_procedure import ExplanationOfBenefitProcedure
    from spark_auto_mapper_fhir.complex_types.positive_int import positiveInt
    from spark_auto_mapper_fhir.backbone_elements.explanation_of_benefit_insurance import ExplanationOfBenefitInsurance
    from spark_auto_mapper_fhir.backbone_elements.explanation_of_benefit_accident import ExplanationOfBenefitAccident
    from spark_auto_mapper_fhir.backbone_elements.explanation_of_benefit_item import ExplanationOfBenefitItem
    from spark_auto_mapper_fhir.backbone_elements.explanation_of_benefit_add_item import ExplanationOfBenefitAddItem
    ...
    from spark_auto_mapper_fhir.backbone_elements.explanation_of_benefit_total import ExplanationOfBenefitTotal
    ...
    from spark_auto_mapper_fhir.complex_types.forms import Forms
    ...
    from spark_auto_mapper_fhir.complex_types.period import Period
    from spark_auto_mapper_fhir.backbone_elements.explanation_of_benefit_benefit_balance import ExplanationOfBenefitBenefitBalance
...
class ExplanationOfBenefit(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        subType: Optional[CodeableConcept[ClaimSubType] ] = None,
        use: Use ,
        ...
        priority: Optional[CodeableConcept[ProcessPriority] ] = None,
        fundsReserveRequested: Optional[CodeableConcept[FundsReserve] ] = None,
        fundsReserve: Optional[CodeableConcept[FundsReserve] ] = None,
        ...
        formCode: Optional[CodeableConcept[Forms] ] = None,
    ...
    def get_schema(
        ...
        return ExplanationOfBenefitSchema.get_schema(include_extension=include_extension)
