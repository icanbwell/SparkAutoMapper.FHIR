...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.explanation_of_benefit_status import ExplanationOfBenefitStatusCode
    ...
    from spark_auto_mapper_fhir.value_sets.example_claim_sub_type_codes import ExampleClaimSubTypeCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.process_priority_codes import ProcessPriorityCodesCode
    # End Import for CodeableConcept for priority
    # fundsReserveRequested (CodeableConcept)
    # Import for CodeableConcept for fundsReserveRequested
    from spark_auto_mapper_fhir.value_sets.funds_reservation_codes import FundsReservationCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.claim_processing_codes import ClaimProcessingCodesCode
    # disposition (string)
    # preAuthRef (string)
...
class ExplanationOfBenefit(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        fundsReserveRequested: Optional[CodeableConcept[FundsReservationCodesCode] ] = None,
