...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.flag_category import FlagCategory
    # End Import for CodeableConcept for category
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for code
    from spark_auto_mapper_fhir.value_sets.flag_code import FlagCode
...
class Flag(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        subject: Reference [Union[Patient, Location, Group, Organization, Practitioner, PlanDefinition, Medication, Procedure]],
        period: Optional[Period ] = None,
        encounter: Optional[Reference [Union[Encounter]]] = None,
        author: Optional[Reference [Union[Device, Organization, Patient, Practitioner, PractitionerRole]]] = None,
    ) -> None:
        """
