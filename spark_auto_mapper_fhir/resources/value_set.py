...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.value_set_compose import ValueSetCompose
    # expansion (ValueSet.Expansion)
    from spark_auto_mapper_fhir.backbone_elements.value_set_expansion import ValueSetExpansion
