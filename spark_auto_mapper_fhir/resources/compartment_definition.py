...
from spark_fhir_schemas.r4.resources.compartmentdefinition import CompartmentDefinitionSchema
...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.compartment_definition_resource import CompartmentDefinitionResource
...
class CompartmentDefinition(FhirResourceBase):
    ...
    def get_schema(
        ...
        return CompartmentDefinitionSchema.get_schema(include_extension=include_extension)
