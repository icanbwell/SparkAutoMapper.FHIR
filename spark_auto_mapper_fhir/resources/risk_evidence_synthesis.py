...
from spark_fhir_schemas.r4.resources.riskevidencesynthesis import RiskEvidenceSynthesisSchema
...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.risk_evidence_synthesis_sample_size import RiskEvidenceSynthesisSampleSize
    # riskEstimate (RiskEvidenceSynthesis.RiskEstimate)
    from spark_auto_mapper_fhir.backbone_elements.risk_evidence_synthesis_risk_estimate import RiskEvidenceSynthesisRiskEstimate
    # certainty (RiskEvidenceSynthesis.Certainty)
    from spark_auto_mapper_fhir.backbone_elements.risk_evidence_synthesis_certainty import RiskEvidenceSynthesisCertainty
...
class RiskEvidenceSynthesis(FhirResourceBase):
    ...
    def get_schema(
        ...
        return RiskEvidenceSynthesisSchema.get_schema(include_extension=include_extension)
