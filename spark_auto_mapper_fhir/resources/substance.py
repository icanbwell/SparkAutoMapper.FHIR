...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.substance_category import SubstanceCategory
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for code
    from spark_auto_mapper_fhir.complex_types.substance_code import SubstanceCode
...
class Substance(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        category: Optional[FhirList[CodeableConcept[SubstanceCategory] ]] = None,
