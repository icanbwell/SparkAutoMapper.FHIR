...
from spark_fhir_schemas.r4.resources.medicinalproductpharmaceutical import MedicinalProductPharmaceuticalSchema
...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.medicinal_product_pharmaceutical_characteristics import MedicinalProductPharmaceuticalCharacteristics
    from spark_auto_mapper_fhir.backbone_elements.medicinal_product_pharmaceutical_route_of_administration import MedicinalProductPharmaceuticalRouteOfAdministration
...
class MedicinalProductPharmaceutical(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        characteristics: Optional[FhirList[MedicinalProductPharmaceuticalCharacteristics ]] = None,
        routeOfAdministration: FhirList[MedicinalProductPharmaceuticalRouteOfAdministration ],
    ) -> None:
        """
    ...
    def get_schema(
        ...
        return MedicinalProductPharmaceuticalSchema.get_schema(include_extension=include_extension)
