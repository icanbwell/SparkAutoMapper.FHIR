...
from spark_fhir_schemas.r4.resources.capabilitystatement import CapabilityStatementSchema
...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.capability_statement_kind import CapabilityStatementKindCode
    # instantiates (canonical)
    from spark_auto_mapper_fhir.fhir_types.canonical import FhirCanonical
    # imports (canonical)
    # software (CapabilityStatement.Software)
    from spark_auto_mapper_fhir.backbone_elements.capability_statement_software import CapabilityStatementSoftware
    # implementation (CapabilityStatement.Implementation)
    from spark_auto_mapper_fhir.backbone_elements.capability_statement_implementation import CapabilityStatementImplementation
    ...
    from spark_auto_mapper_fhir.backbone_elements.capability_statement_rest import CapabilityStatementRest
    # messaging (CapabilityStatement.Messaging)
    from spark_auto_mapper_fhir.backbone_elements.capability_statement_messaging import CapabilityStatementMessaging
    # document (CapabilityStatement.Document)
    from spark_auto_mapper_fhir.backbone_elements.capability_statement_document import CapabilityStatementDocument
