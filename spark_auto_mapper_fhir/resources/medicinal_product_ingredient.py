...
from spark_fhir_schemas.r4.resources.medicinalproductingredient import MedicinalProductIngredientSchema
...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.medicinal_product_ingredient_specified_substance import MedicinalProductIngredientSpecifiedSubstance
    from spark_auto_mapper_fhir.backbone_elements.medicinal_product_ingredient_substance import MedicinalProductIngredientSubstance
...
class MedicinalProductIngredient(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        specifiedSubstance: Optional[FhirList[MedicinalProductIngredientSpecifiedSubstance ]] = None,
    ...
    def get_schema(
        ...
        return MedicinalProductIngredientSchema.get_schema(include_extension=include_extension)
