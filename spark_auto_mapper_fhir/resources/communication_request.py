...
from spark_fhir_schemas.r4.resources.communicationrequest import CommunicationRequestSchema
...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.communication_request_status_reason import CommunicationRequestStatusReason
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for category
    from spark_auto_mapper_fhir.complex_types.communication_category import CommunicationCategory
    ...
    from spark_auto_mapper_fhir.complex_types.communication_medium import CommunicationMedium
    from spark_auto_mapper_fhir.complex_types.reference import Reference
    ...
    from spark_auto_mapper_fhir.backbone_elements.communication_request_payload import CommunicationRequestPayload
    ...
    from spark_auto_mapper_fhir.complex_types.communication_reason import CommunicationReason
    from spark_auto_mapper_fhir.complex_types.reference import Reference
...
class CommunicationRequest(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        statusReason: Optional[CodeableConcept[CommunicationRequestStatusReason] ] = None,
        ...
        recipient: Optional[FhirList[Reference [Union[Device, Organization, Patient, Practitioner, PractitionerRole, RelatedPerson, Group, CareTeam, HealthcareService]]]] = None,
        sender: Optional[Reference [Union[Device, Organization, Patient, Practitioner, PractitionerRole, RelatedPerson, HealthcareService]]] = None,
    ...
    def get_schema(
        ...
        return CommunicationRequestSchema.get_schema(include_extension=include_extension)
