...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.communication_category import CommunicationCategoryCode
...
class CommunicationRequest(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        statusReason: Optional[CodeableConcept[ACMECholCodesBloodCode] ] = None,
