...
from spark_fhir_schemas.r4.resources.chargeitemdefinition import ChargeItemDefinitionSchema
...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.charge_item_definition_property_group import ChargeItemDefinitionPropertyGroup
...
class ChargeItemDefinition(FhirResourceBase):
    ...
    def get_schema(
        ...
        return ChargeItemDefinitionSchema.get_schema(include_extension=include_extension)
