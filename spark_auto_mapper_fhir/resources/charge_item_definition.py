...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.charge_item_definition_code import ChargeItemDefinitionCode
...
class ChargeItemDefinition(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        code: Optional[CodeableConcept[ChargeItemDefinitionCode] ] = None,
