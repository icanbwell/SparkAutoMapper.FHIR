...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.consent_scope import ConsentScope
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for category
    from spark_auto_mapper_fhir.complex_types.consent_category import ConsentCategory
    ...
    from spark_auto_mapper_fhir.complex_types.consent_policy_rule import ConsentPolicyRule
...
class Consent(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        status: ConsentState ,
        scope: CodeableConcept[ConsentScope] ,
        category: FhirList[CodeableConcept[ConsentCategory] ],
        ...
        policyRule: Optional[CodeableConcept[ConsentPolicyRule] ] = None,
