...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.consent_scope_codes import ConsentScopeCodesCode
    # End Import for CodeableConcept for scope
    # category (CodeableConcept)
    # Import for CodeableConcept for category
    from spark_auto_mapper_fhir.value_sets.consent_category_codes import ConsentCategoryCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.consent_policy_rule_codes import ConsentPolicyRuleCodesCode
...
class Consent(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        sourceReference: Optional[Reference [Union[Consent, DocumentReference, Contract, QuestionnaireResponse]]] = None,
