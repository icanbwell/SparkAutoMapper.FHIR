...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.device_metric_and_component_types import DeviceMetricAndComponentTypesCode
    ...
    from spark_auto_mapper_fhir.value_sets.device_metric_operational_status import DeviceMetricOperationalStatusCode
    # color (DeviceMetricColor)
    from spark_auto_mapper_fhir.value_sets.device_metric_color import DeviceMetricColorCode
    # category (DeviceMetricCategory)
    from spark_auto_mapper_fhir.value_sets.device_metric_category import DeviceMetricCategoryCode
