...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.resources.research_element_definition import ResearchElementDefinition
    # exposure (Reference)
...
class ResearchDefinition(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        exposureAlternative: Optional[Reference [Union[ResearchElementDefinition]]] = None,
