...
class ResearchDefinition(FhirResourceBase):
    """
    ResearchDefinition
    """
    ...
    def __init__(
        ...
        *,
        ...
        stored on different servers.
            :param identifier: A formal identifier that is used to identify this research definition when it
        ...
        contexts where the full, formal title is not necessary.
            :param subtitle: An explanatory or alternate title for the ResearchDefinition giving additional
        information about its content.
            :param status: The status of this research definition. Enables tracking the life-cycle of the
        content.
            :param experimental: A Boolean value to indicate that this research definition is authored for
        testing purposes (or education/evaluation/marketing) and is not intended to be
        used for genuine usage.
            :param date: The date  (and optionally time) when the research definition was published.
        ...
        publisher.
            :param description: A free text natural language description of the research definition from a
        ...
        definition instances.
            :param jurisdiction: A legal or geographic region in which the research definition is intended to
        be used.
        ...
        ResearchDefinition is used.
            :param copyright: A copyright statement relating to the research definition and/or its contents.
        ...
        periodically after approval but does not change the original approval date.
            :param effectivePeriod: The period during which the research definition content was or is planned to
        be in active use.
        ...
        population for the research.
            :param exposure: A reference to a ResearchElementDefinition resource that defines the exposure
        for the research.
            :param exposureAlternative: A reference to a ResearchElementDefinition resource that defines the
    ...
    def get_schema(
        ...
        return ResearchDefinitionSchema.get_schema(include_extension=include_extension)
