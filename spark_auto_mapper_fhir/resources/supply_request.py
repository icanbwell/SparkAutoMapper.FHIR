...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.supply_request_kind import SupplyRequestKind
    ...
    from spark_auto_mapper_fhir.complex_types.supply_request_reason import SupplyRequestReason
    from spark_auto_mapper_fhir.complex_types.reference import Reference
...
class SupplyRequest(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        category: Optional[CodeableConcept[SupplyRequestKind] ] = None,
