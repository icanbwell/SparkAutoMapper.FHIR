...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.medication_statement_status_reason import (
        MedicationStatementStatusReason,
    )
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept

    # Import for CodeableConcept for category
    from spark_auto_mapper_fhir.complex_types.medication_statement_category import (
    ...
    def __init__(
        ...
        *,
        ...
        statusReason: Optional[
            FhirList[CodeableConcept[MedicationStatementStatusReason]]
        ] = None,
