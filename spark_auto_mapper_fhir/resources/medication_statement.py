...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.medication_status_codes import MedicationStatusCodesCode
    # statusReason (CodeableConcept)
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for statusReason
    from spark_auto_mapper_fhir.value_sets.snomedct_drug_therapy_status_codes import SNOMEDCTDrugTherapyStatusCodesCode
    # End Import for CodeableConcept for statusReason
    # category (CodeableConcept)
    # Import for CodeableConcept for category
    from spark_auto_mapper_fhir.value_sets.medication_usage_category_codes import MedicationUsageCategoryCodesCode
...
class MedicationStatement(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        statusReason: Optional[FhirList[CodeableConcept[SNOMEDCTDrugTherapyStatusCodesCode] ]] = None,
