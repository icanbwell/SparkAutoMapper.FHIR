...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.collected_specimen_type import CollectedSpecimenType
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for patientPreparation
    from spark_auto_mapper_fhir.complex_types.prepare_patient import PreparePatient
    from spark_auto_mapper_fhir.complex_types.string import FhirString
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for collection
    from spark_auto_mapper_fhir.complex_types.specimen_collection import SpecimenCollection
    from spark_auto_mapper_fhir.backbone_elements.specimen_definition_type_tested import SpecimenDefinitionTypeTested
...
class SpecimenDefinition(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        typeCollected: Optional[CodeableConcept[CollectedSpecimenType] ] = None,
