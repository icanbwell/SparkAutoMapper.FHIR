...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.specimen_collection import SpecimenCollectionCode
...
class SpecimenDefinition(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        patientPreparation: Optional[FhirList[CodeableConcept[PreparePatientCode] ]] = None,
