...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.device_request_participant_role import DeviceRequestParticipantRole
    from spark_auto_mapper_fhir.complex_types.reference import Reference
    ...
    from spark_auto_mapper_fhir.complex_types.device_request_reason import DeviceRequestReason
    from spark_auto_mapper_fhir.complex_types.reference import Reference
...
class DeviceRequest(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        performerType: Optional[CodeableConcept[DeviceRequestParticipantRole] ] = None,
        ...
        reasonCode: Optional[FhirList[CodeableConcept[DeviceRequestReason] ]] = None,
