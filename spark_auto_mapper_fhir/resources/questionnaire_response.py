...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.questionnaire_response_status import QuestionnaireResponseStatusCode
    # subject (Reference)
    ...
    from spark_auto_mapper_fhir.backbone_elements.questionnaire_response_item import QuestionnaireResponseItem
...
class QuestionnaireResponse(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        author: Optional[Reference [Union[Device, Practitioner, PractitionerRole, Patient, RelatedPerson, Organization]]] = None,
        source: Optional[Reference [Union[Patient, Practitioner, PractitionerRole, RelatedPerson]]] = None,
    ...
    def get_schema(
        ...
        return QuestionnaireResponseSchema.get_schema(include_extension=include_extension)
