...
from spark_fhir_schemas.r4.resources.medicinalproductcontraindication import MedicinalProductContraindicationSchema
...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.medicinal_product_contraindication_other_therapy import MedicinalProductContraindicationOtherTherapy
...
class MedicinalProductContraindication(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        therapeuticIndication: Optional[FhirList[Reference [Union[MedicinalProductIndication]]]] = None,
        otherTherapy: Optional[FhirList[MedicinalProductContraindicationOtherTherapy ]] = None,
    ...
    def get_schema(
        ...
        return MedicinalProductContraindicationSchema.get_schema(include_extension=include_extension)
