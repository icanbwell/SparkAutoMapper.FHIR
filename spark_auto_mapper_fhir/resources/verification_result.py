...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.validation_process import Validation_processCode
...
class VerificationResult(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        validationProcess: Optional[FhirList[CodeableConcept[Validation_processCode] ]] = None,
