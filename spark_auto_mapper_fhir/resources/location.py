...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.operational_status import OperationalStatus
    ...
    from spark_auto_mapper_fhir.backbone_elements.location_hours_of_operation import LocationHoursOfOperation
    from spark_auto_mapper_fhir.complex_types.string import FhirString
    from spark_auto_mapper_fhir.complex_types.reference import Reference
