...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.care_team_category import CareTeamCategory
    ...
    from spark_auto_mapper_fhir.complex_types.care_team_reason import CareTeamReason
    from spark_auto_mapper_fhir.complex_types.reference import Reference
...
class CareTeam(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        reasonCode: Optional[FhirList[CodeableConcept[CareTeamReason]]] = None,
