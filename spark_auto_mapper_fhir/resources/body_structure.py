...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.body_structure_code import (
        BodyStructureCode,
    )
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    ...
    from spark_auto_mapper_fhir.complex_types.body_structure_qualifier import (
        BodyStructureQualifier,
    )
    ...
    def __init__(
        ...
        *,
        ...
        locationQualifier: Optional[
            FhirList[CodeableConcept[BodyStructureQualifier]]
        ] = None,
