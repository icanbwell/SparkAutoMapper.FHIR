...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.document_manifest_related import DocumentManifestRelated
...
class DocumentManifest(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        recipient: Optional[FhirList[Reference [Union[Patient, Practitioner, PractitionerRole, RelatedPerson, Organization]]]] = None,
    ...
    independent  identifiers.
        ...
        :param type: The code specifying the type of clinical activity that resulted in placing the
