...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.immunization_recommendation_recommendation import ImmunizationRecommendationRecommendation
...
class ImmunizationRecommendation(FhirResourceBase):
    ...
    def get_schema(
        ...
        return ImmunizationRecommendationSchema.get_schema(include_extension=include_extension)
