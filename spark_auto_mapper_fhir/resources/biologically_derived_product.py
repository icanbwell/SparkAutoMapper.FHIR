...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.biologically_derived_product_code import BiologicallyDerivedProductCode
...
class BiologicallyDerivedProduct(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        productCode: Optional[CodeableConcept[BiologicallyDerivedProductCode] ] = None,
