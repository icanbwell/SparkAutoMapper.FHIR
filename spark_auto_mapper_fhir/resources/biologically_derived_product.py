...
from spark_fhir_schemas.r4.resources.biologicallyderivedproduct import BiologicallyDerivedProductSchema
...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.biologically_derived_product_category import BiologicallyDerivedProductCategoryCode
    ...
    from spark_auto_mapper_fhir.value_sets.biologically_derived_product_status import BiologicallyDerivedProductStatusCode
    # request (Reference)
    ...
    from spark_auto_mapper_fhir.backbone_elements.biologically_derived_product_collection import BiologicallyDerivedProductCollection
    # processing (BiologicallyDerivedProduct.Processing)
    from spark_auto_mapper_fhir.backbone_elements.biologically_derived_product_processing import BiologicallyDerivedProductProcessing
    # manipulation (BiologicallyDerivedProduct.Manipulation)
    from spark_auto_mapper_fhir.backbone_elements.biologically_derived_product_manipulation import BiologicallyDerivedProductManipulation
    # storage (BiologicallyDerivedProduct.Storage)
    from spark_auto_mapper_fhir.backbone_elements.biologically_derived_product_storage import BiologicallyDerivedProductStorage
...
class BiologicallyDerivedProduct(FhirResourceBase):
    ...
    def get_schema(
        ...
        return BiologicallyDerivedProductSchema.get_schema(include_extension=include_extension)
