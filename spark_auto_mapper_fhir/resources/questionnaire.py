...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.questionnaire_question_codes import QuestionnaireQuestionCodesCode
...
class Questionnaire(FhirResourceBase):
    ...
    can be placed in a lexicographical sequence.
        :param name: A natural language name identifying the questionnaire. This name should be
    ...
    content.
        :param experimental: A Boolean value to indicate that this questionnaire is authored for testing
    ...
    periodically after approval but does not change the original approval date.
        :param effectivePeriod: The period during which the questionnaire content was or is planned to be in
    active use.
