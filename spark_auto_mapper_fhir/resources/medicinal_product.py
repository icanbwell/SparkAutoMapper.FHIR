...
class MedicinalProduct(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        combinedPharmaceuticalDoseForm: Optional[CodeableConcept[GenericTypeCode] ] = None,
        legalStatusOfSupply: Optional[CodeableConcept[GenericTypeCode] ] = None,
        additionalMonitoringIndicator: Optional[CodeableConcept[GenericTypeCode] ] = None,
        specialMeasures: Optional[FhirList[FhirString ]] = None,
        paediatricUseIndicator: Optional[CodeableConcept[GenericTypeCode] ] = None,
        productClassification: Optional[FhirList[CodeableConcept[GenericTypeCode] ]] = None,
