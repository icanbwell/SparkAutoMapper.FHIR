...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.contract_resource_status_codes import ContractResourceStatusCodesCode
    # legalState (CodeableConcept)
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for legalState
    from spark_auto_mapper_fhir.value_sets.contract_resource_legal_state_codes import ContractResourceLegalStateCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.contract_content_derivation_codes import ContractContentDerivationCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.contract_resource_expiration_type_codes import ContractResourceExpirationTypeCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.contract_type_codes import ContractTypeCodesCode
    # End Import for CodeableConcept for type_
    # subType (CodeableConcept)
    # Import for CodeableConcept for subType
    from spark_auto_mapper_fhir.value_sets.contract_subtype_codes import ContractSubtypeCodesCode
...
class Contract(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        legalState: Optional[CodeableConcept[ContractResourceLegalStateCodesCode] ] = None,
        instantiatesCanonical: Optional[Reference [Union[Contract]]] = None,
        instantiatesUri: Optional[FhirUri ] = None,
        contentDerivative: Optional[CodeableConcept[ContractContentDerivationCodesCode] ] = None,
        issued: Optional[FhirDateTime ] = None,
        applies: Optional[Period ] = None,
        expirationType: Optional[CodeableConcept[ContractResourceExpirationTypeCodesCode] ] = None,
        ...
        legallyBindingReference: Optional[Reference [Union[Composition, DocumentReference, QuestionnaireResponse, Contract]]] = None,
    ) -> None:
        """
        Legally enforceable, formally recorded unilateral or bilateral directive i.e.,
    a policy or agreement.
