...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.contract_legal_state import ContractLegalState
    from spark_auto_mapper_fhir.complex_types.reference import Reference
    # Imports for References for instantiatesCanonical
    from spark_auto_mapper_fhir.complex_types.uri import uri
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for contentDerivative
    from spark_auto_mapper_fhir.complex_types.contract_content_derivative import ContractContentDerivative
    from spark_auto_mapper_fhir.complex_types.date_time import FhirDateTime
    from spark_auto_mapper_fhir.complex_types.period import Period
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for expirationType
    from spark_auto_mapper_fhir.complex_types.contract_expiration import ContractExpiration
    from spark_auto_mapper_fhir.complex_types.reference import Reference
