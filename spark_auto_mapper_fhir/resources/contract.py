...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.contract_legal_state import (
        ContractLegalState,
    )
    ...
    from spark_auto_mapper_fhir.complex_types.contract_content_derivative import (
    ...
    from spark_auto_mapper_fhir.complex_types.contract_expiration import (
        ContractExpiration,
    )
    from spark_auto_mapper_fhir.complex_types.reference import Reference
    ...
    from spark_auto_mapper_fhir.complex_types.contract_scope import ContractScope
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept

    # Import for CodeableConcept for type
    from spark_auto_mapper_fhir.complex_types.contract_type import ContractType
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept

    # Import for CodeableConcept for subType
    from spark_auto_mapper_fhir.complex_types.contract_subtype import ContractSubtype
...
class Contract(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        legalState: Optional[CodeableConcept[ContractLegalState]] = None,
        instantiatesCanonical: Optional[Reference[Union[Contract]]] = None,
        instantiatesUri: Optional[uri] = None,
        contentDerivative: Optional[CodeableConcept[ContractContentDerivative]] = None,
        issued: Optional[FhirDateTime] = None,
        applies: Optional[Period] = None,
        expirationType: Optional[CodeableConcept[ContractExpiration]] = None,
        ...
        scope: Optional[CodeableConcept[ContractScope]] = None,
        type: Optional[CodeableConcept[ContractType]] = None,
        subType: Optional[FhirList[CodeableConcept[ContractSubtype]]] = None,
