...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.patient_diet import PatientDiet
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for excludeFoodModifier
    from spark_auto_mapper_fhir.complex_types.food_type import FoodType
...
class NutritionOrder(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        foodPreferenceModifier: Optional[FhirList[CodeableConcept[PatientDiet] ]] = None,
        excludeFoodModifier: Optional[FhirList[CodeableConcept[FoodType] ]] = None,
