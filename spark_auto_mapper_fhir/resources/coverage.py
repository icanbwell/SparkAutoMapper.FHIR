...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.coverage_class import CoverageClass
    ...
    from spark_auto_mapper_fhir.complex_types.relationship import Relationship
...
class Coverage(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        type: Optional[CodeableConcept[CoverageClass]] = None,
        ...
        relationship: Optional[CodeableConcept[Relationship]] = None,
