...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.charge_item_status import ChargeItemStatusCode
    # partOf (Reference)
...
class ChargeItem(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        productReference: Optional[Reference [Union[Device, Medication, Substance]]] = None,
