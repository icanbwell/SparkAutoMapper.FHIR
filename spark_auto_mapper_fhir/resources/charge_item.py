...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.charge_item_code import ChargeItemCode
    from spark_auto_mapper_fhir.complex_types.reference import Reference
    ...
    from spark_auto_mapper_fhir.complex_types.charge_item_reason import ChargeItemReason
    from spark_auto_mapper_fhir.complex_types.reference import Reference
...
class ChargeItem(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        reason: Optional[FhirList[CodeableConcept[ChargeItemReason]]] = None,
        service: Optional[
            FhirList[
                Reference[
                    Union[
