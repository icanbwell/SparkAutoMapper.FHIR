...
from spark_fhir_schemas.r4.resources.appointmentresponse import AppointmentResponseSchema
...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.participation_status import ParticipationStatusCode
    # comment (string)
...
class AppointmentResponse(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        participantType: Optional[FhirList[CodeableConcept[ParticipantTypeCode] ]] = None,
