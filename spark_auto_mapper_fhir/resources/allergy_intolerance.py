...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.allergy_intolerance_clinical_status import (
        AllergyIntoleranceClinicalStatus,
    )
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept

    # Import for CodeableConcept for verificationStatus
    from spark_auto_mapper_fhir.complex_types.allergy_intolerance_verification_status import (
    ...
    from spark_auto_mapper_fhir.complex_types.allergy_intolerance_code import (
    ...
    def __init__(
        ...
        *,
        ...
        clinicalStatus: Optional[
            CodeableConcept[AllergyIntoleranceClinicalStatus]
        ] = None,
        verificationStatus: Optional[
            CodeableConcept[AllergyIntoleranceVerificationStatus]
        ] = None,
