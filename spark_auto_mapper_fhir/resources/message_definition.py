...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.message_significance_category import MessageSignificanceCategoryCode
    # focus (MessageDefinition.Focus)
    from spark_auto_mapper_fhir.backbone_elements.message_definition_focus import MessageDefinitionFocus
    # responseRequired (messageheader-response-request)
    from spark_auto_mapper_fhir.value_sets.messageheader_response_request import Messageheader_response_requestCode
    # allowedResponse (MessageDefinition.AllowedResponse)
    from spark_auto_mapper_fhir.backbone_elements.message_definition_allowed_response import MessageDefinitionAllowedResponse
    # graph (canonical)
