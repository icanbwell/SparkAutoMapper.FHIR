...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.device_use_statement_status import DeviceUseStatementStatusCode
    # subject (Reference)
...
class DeviceUseStatement(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        derivedFrom: Optional[FhirList[Reference [Union[ServiceRequest, Procedure, Claim, Observation, QuestionnaireResponse, DocumentReference]]]] = None,
        ...
        reasonReference: Optional[FhirList[Reference [Union[Condition, Observation, DiagnosticReport, DocumentReference, Media]]]] = None,
