...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.patient_relationship_type import PatientRelationshipType
...
class RelatedPerson(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        relationship: Optional[FhirList[CodeableConcept[PatientRelationshipType] ]] = None,
