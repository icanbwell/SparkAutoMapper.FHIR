...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.patient_relationship_type import PatientRelationshipTypeCode
    ...
    from spark_auto_mapper_fhir.backbone_elements.related_person_communication import RelatedPersonCommunication
...
class RelatedPerson(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        relationship: Optional[FhirList[CodeableConcept[PatientRelationshipTypeCode] ]] = None,
