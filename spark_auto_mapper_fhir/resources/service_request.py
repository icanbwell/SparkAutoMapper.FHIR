...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.service_request_category_codes import ServiceRequestCategoryCodes
    ...
    from spark_auto_mapper_fhir.value_sets.service_request_order_details_codes import ServiceRequestOrderDetailsCodes
...
class ServiceRequest(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        category: Optional[FhirList[CodeableConcept[ServiceRequestCategoryCodes] ]] = None,
        priority: Optional[RequestPriority ] = None,
        doNotPerform: Optional[FhirBoolean ] = None,
        code: Optional[CodeableConcept[ProcedureCodes_SNOMEDCT_] ] = None,
        orderDetail: Optional[FhirList[CodeableConcept[ServiceRequestOrderDetailsCodes] ]] = None,
