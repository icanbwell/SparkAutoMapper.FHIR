...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.service_request_category_codes import ServiceRequestCategoryCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.service_request_order_details_codes import ServiceRequestOrderDetailsCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.service_delivery_location_role_type import ServiceDeliveryLocationRoleType
...
class ServiceRequest(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        category: Optional[FhirList[CodeableConcept[ServiceRequestCategoryCodesCode] ]] = None,
        ...
        orderDetail: Optional[FhirList[CodeableConcept[ServiceRequestOrderDetailsCodesCode] ]] = None,
        ...
        locationCode: Optional[FhirList[CodeableConcept[ServiceDeliveryLocationRoleType] ]] = None,
