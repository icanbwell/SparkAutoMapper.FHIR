...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.service_request_category import ServiceRequestCategory
    from spark_auto_mapper_fhir.complex_types.request_priority import RequestPriority
    from spark_auto_mapper_fhir.complex_types.boolean import FhirBoolean
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for code
    from spark_auto_mapper_fhir.complex_types.service_request_code import ServiceRequestCode
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for orderDetail
    from spark_auto_mapper_fhir.complex_types.order_detail import OrderDetail
    from spark_auto_mapper_fhir.complex_types.reference import Reference
    ...
    from spark_auto_mapper_fhir.complex_types.service_request_participant_role import ServiceRequestParticipantRole
    from spark_auto_mapper_fhir.complex_types.reference import Reference
    ...
    from spark_auto_mapper_fhir.complex_types.service_request_location import ServiceRequestLocation
    from spark_auto_mapper_fhir.complex_types.reference import Reference
    # Imports for References for locationReference
    from spark_auto_mapper_fhir.resources.location import Location
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for reasonCode
    from spark_auto_mapper_fhir.complex_types.service_request_reason import ServiceRequestReason
    from spark_auto_mapper_fhir.complex_types.reference import Reference
...
class ServiceRequest(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        category: Optional[FhirList[CodeableConcept[ServiceRequestCategory] ]] = None,
        priority: Optional[RequestPriority ] = None,
        doNotPerform: Optional[FhirBoolean ] = None,
        code: Optional[CodeableConcept[ServiceRequestCode] ] = None,
        orderDetail: Optional[FhirList[CodeableConcept[OrderDetail] ]] = None,
        ...
        performerType: Optional[CodeableConcept[ServiceRequestParticipantRole] ] = None,
        ...
        locationCode: Optional[FhirList[CodeableConcept[ServiceRequestLocation] ]] = None,
        locationReference: Optional[FhirList[Reference [Union[Location]]]] = None,
        reasonCode: Optional[FhirList[CodeableConcept[ServiceRequestReason] ]] = None,
