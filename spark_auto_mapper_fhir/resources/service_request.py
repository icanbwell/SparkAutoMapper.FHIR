...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.service_request_category import (
    ...
    from spark_auto_mapper_fhir.complex_types.service_request_code import (
        ServiceRequestCode,
    )
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    ...
    from spark_auto_mapper_fhir.complex_types.service_request_participant_role import (
        ServiceRequestParticipantRole,
    )
    from spark_auto_mapper_fhir.complex_types.reference import Reference
    ...
    from spark_auto_mapper_fhir.complex_types.service_request_location import (
    ...
    from spark_auto_mapper_fhir.complex_types.service_request_reason import (
    ...
    def __init__(
        ...
        *,
        ...
        locationCode: Optional[
            FhirList[CodeableConcept[ServiceRequestLocation]]
        ] = None,
