...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.code_system_hierarchy_meaning import CodeSystemHierarchyMeaningCode
    # compositional (boolean)
    # versionNeeded (boolean)
    # content (CodeSystemContentMode)
    from spark_auto_mapper_fhir.value_sets.code_system_content_mode import CodeSystemContentModeCode
    # supplements (canonical)
    # count (unsignedInt)
    from spark_auto_mapper_fhir.complex_types.unsigned_int import unsignedInt
    # filter (CodeSystem.Filter)
    from spark_auto_mapper_fhir.backbone_elements.code_system_filter import CodeSystemFilter
    # property (CodeSystem.Property)
    from spark_auto_mapper_fhir.backbone_elements.code_system_property import CodeSystemProperty
