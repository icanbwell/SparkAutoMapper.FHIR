...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.catalog_entry_related_entry import CatalogEntryRelatedEntry
...
class CatalogEntry(FhirResourceBase):
    ...
    def __init__(
        ...
        *,
        ...
        referencedItem: Reference [Union[Medication, Device, Organization, Practitioner, PractitionerRole, HealthcareService, ActivityDefinition, PlanDefinition, SpecimenDefinition, ObservationDefinition, Binary]],
        ...
        additionalCharacteristic: Optional[FhirList[CodeableConcept[GenericTypeCode] ]] = None,
        additionalClassification: Optional[FhirList[CodeableConcept[GenericTypeCode] ]] = None,
