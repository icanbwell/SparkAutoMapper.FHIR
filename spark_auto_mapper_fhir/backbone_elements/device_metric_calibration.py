...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.device_metric_calibration_type import DeviceMetricCalibrationTypeCode
    # state (DeviceMetricCalibrationState)
    from spark_auto_mapper_fhir.value_sets.device_metric_calibration_state import DeviceMetricCalibrationStateCode
    # time (instant)
