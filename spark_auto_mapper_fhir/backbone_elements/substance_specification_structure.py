...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.substance_specification_isotope import SubstanceSpecificationIsotope
    ...
    from spark_auto_mapper_fhir.backbone_elements.substance_specification_representation import SubstanceSpecificationRepresentation
