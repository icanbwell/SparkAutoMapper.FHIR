...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.care_plan_activity_outcome import CarePlanActivityOutcome
...
class CarePlanActivity(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        outcomeCodeableConcept: Optional[FhirList[CodeableConcept[CarePlanActivityOutcome] ]] = None,
