...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.contract_actor_role_codes import ContractActorRoleCodes
...
class ContractSubject(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        reference: FhirList[Reference [Union[Patient, RelatedPerson, Practitioner, PractitionerRole, Device, Group, Organization]]],
        role: Optional[CodeableConcept[ContractActorRoleCodes] ] = None,
    ) -> None:
        """
