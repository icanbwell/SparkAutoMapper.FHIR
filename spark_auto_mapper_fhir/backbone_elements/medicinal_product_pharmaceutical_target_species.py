...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.medicinal_product_pharmaceutical_withdrawal_period import MedicinalProductPharmaceuticalWithdrawalPeriod
...
class MedicinalProductPharmaceuticalTargetSpecies(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        withdrawalPeriod: Optional[FhirList[MedicinalProductPharmaceuticalWithdrawalPeriod]] = None,
    ) -> None:
        """
