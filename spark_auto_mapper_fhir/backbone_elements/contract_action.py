...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.contract_action_codes import ContractActionCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.contract_resource_action_status_codes import ContractResourceActionStatusCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.provenance_participant_role import ProvenanceParticipantRoleCode
...
class ContractAction(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        performerType: Optional[FhirList[CodeableConcept[ProvenanceParticipantTypeCode] ]] = None,
