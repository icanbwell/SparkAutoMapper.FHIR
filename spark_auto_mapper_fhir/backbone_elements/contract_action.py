...
class ContractAction(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        contextLinkId: Optional[FhirList[string]] = None,
        requester: Optional[
            FhirList[
                Reference[
                    Union[
        ...
        requesterLinkId: Optional[FhirList[string]] = None,
        ...
        performerLinkId: Optional[FhirList[string]] = None,
        ...
        reason: Optional[FhirList[string]] = None,
        reasonLinkId: Optional[FhirList[string]] = None,
