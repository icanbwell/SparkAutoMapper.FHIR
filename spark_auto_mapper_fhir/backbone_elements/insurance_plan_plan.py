...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.insurance_plan_general_cost import InsurancePlanGeneralCost
    from spark_auto_mapper_fhir.backbone_elements.insurance_plan_specific_cost import InsurancePlanSpecificCost
...
class InsurancePlanPlan(FhirBackboneElementBase):
    ...
    constant as the resource is updated and propagates from server to server.
        :param type: Type of plan. For example, "Platinum" or "High Deductable".
