...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.patient_contact_relationship import PatientContactRelationship
...
class PatientContact(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        relationship: Optional[FhirList[CodeableConcept[PatientContactRelationship] ]] = None,
