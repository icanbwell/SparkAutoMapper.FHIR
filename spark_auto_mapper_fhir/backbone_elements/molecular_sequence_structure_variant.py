...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.molecular_sequence_outer import MolecularSequenceOuter
    # inner (MolecularSequence.Inner)
    from spark_auto_mapper_fhir.backbone_elements.molecular_sequence_inner import MolecularSequenceInner
