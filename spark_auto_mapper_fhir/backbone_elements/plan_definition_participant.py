...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.action_participant_type import ActionParticipantTypeCode
    # role (CodeableConcept)
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # End Import for References for role
    # Import for CodeableConcept for role
    from spark_auto_mapper_fhir.value_sets.action_participant_role import ActionParticipantRoleCode
