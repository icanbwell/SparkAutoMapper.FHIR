...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.contract_signer_type_codes import ContractSignerTypeCodesCode
...
class ContractSigner(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        party: Reference [Union[Organization, Patient, Practitioner, PractitionerRole, RelatedPerson]],
