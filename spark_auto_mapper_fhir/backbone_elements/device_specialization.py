...
if TYPE_CHECKING:
    ...
    # End Import for References for systemType
    # Import for CodeableConcept for systemType
    from spark_auto_mapper_fhir.value_sets.generic_type import GenericTypeCode

    # End Import for CodeableConcept for systemType
    # version (string)
...
class DeviceSpecialization(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        systemType: CodeableConcept[GenericTypeCode],
