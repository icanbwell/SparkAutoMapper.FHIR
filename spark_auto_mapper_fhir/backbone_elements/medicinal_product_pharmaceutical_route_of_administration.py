...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.medicinal_product_pharmaceutical_target_species import MedicinalProductPharmaceuticalTargetSpecies
...
class MedicinalProductPharmaceuticalRouteOfAdministration(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        targetSpecies: Optional[FhirList[MedicinalProductPharmaceuticalTargetSpecies ]] = None,
    ) -> None:
        """
