...
class ExplanationOfBenefitsAddItemSubDetailBackboneElement(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        """
        AddItemSubDetailBackboneElement Backbone Element in FHIR
        IMPORTANT: To comply with the Spark mapping mechanism, please make sure you add all existing FHIR
        properties not just the ones you need
        https://www.hl7.org/fhir/explanationofbenefit-definitions.html#ExplanationOfBenefit.addItem.detail.subDetail
        """
        super().__init__(
            id_=id_,
            extension=extension,
