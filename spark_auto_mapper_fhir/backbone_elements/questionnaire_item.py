...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.questionnaire_item_type import QuestionnaireItemTypeCode
    ...
    from spark_auto_mapper_fhir.value_sets.enable_when_behavior import EnableWhenBehaviorCode
    # required (boolean)
    # repeats (boolean)
    # readOnly (boolean)
    # maxLength (integer)
