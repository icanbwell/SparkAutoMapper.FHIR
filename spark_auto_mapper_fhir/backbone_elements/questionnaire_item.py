...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.questionnaire_question_codes import QuestionnaireQuestionCodes
    # End Import for CodeableConcept for code
    from spark_auto_mapper_fhir.complex_types.string import string
    from spark_auto_mapper_fhir.complex_types.string import string
    from spark_auto_mapper_fhir.complex_types.questionnaire_item_type import QuestionnaireItemType
    from spark_auto_mapper_fhir.backbone_elements.questionnaire_enable_when import QuestionnaireEnableWhen
    from spark_auto_mapper_fhir.complex_types.enable_when_behavior import EnableWhenBehavior
    ...
    from spark_auto_mapper_fhir.backbone_elements.questionnaire_answer_option import QuestionnaireAnswerOption
    from spark_auto_mapper_fhir.backbone_elements.questionnaire_initial import QuestionnaireInitial
    from spark_auto_mapper_fhir.backbone_elements.questionnaire_item import QuestionnaireItem
...
class QuestionnaireItem(FhirBackboneElementBase):
    ...
    * options (ElementDefinition.binding).
    ...
    item.
        :param type: The type of questionnaire item this is - whether text for display, a grouping
