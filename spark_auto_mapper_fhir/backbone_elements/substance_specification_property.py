...
class SubstanceSpecificationProperty(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        definingSubstanceReference: Optional[Reference [Union[SubstanceSpecification, Substance]]] = None,
        definingSubstanceCodeableConcept: Optional[CodeableConcept[GenericTypeCode] ] = None,
