...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.enteral_formula_type_codes import EnteralFormulaTypeCodes
    # End Import for CodeableConcept for baseFormulaType
    from spark_auto_mapper_fhir.complex_types.string import string
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for additiveType
    from spark_auto_mapper_fhir.value_sets.enteral_formula_additive_type_code import EnteralFormulaAdditiveTypeCode
