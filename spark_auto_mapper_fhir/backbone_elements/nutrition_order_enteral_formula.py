...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.enteral_formula_type_codes import EnteralFormulaTypeCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.enteral_formula_additive_type_code import EnteralFormulaAdditiveTypeCodeCode
    ...
    from spark_auto_mapper_fhir.value_sets.enteral_route_codes import EnteralRouteCodesCode
    # End Import for CodeableConcept for routeofAdministration
    # administration (NutritionOrder.Administration)
    from spark_auto_mapper_fhir.backbone_elements.nutrition_order_administration import NutritionOrderAdministration
...
class NutritionOrderEnteralFormula(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        additiveType: Optional[CodeableConcept[EnteralFormulaAdditiveTypeCodeCode] ] = None,
