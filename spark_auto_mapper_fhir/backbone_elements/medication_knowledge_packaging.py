...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.medication_knowledge_package_type_codes import MedicationKnowledgePackageTypeCodesCode
...
class MedicationKnowledgePackaging(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        type_: Optional[CodeableConcept[MedicationKnowledgePackageTypeCodesCode] ] = None,
