...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.adverse_event_causality_assessment import AdverseEventCausalityAssessment
    ...
    from spark_auto_mapper_fhir.value_sets.adverse_event_causality_method import AdverseEventCausalityMethod
