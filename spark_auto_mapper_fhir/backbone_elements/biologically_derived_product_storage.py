...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.biologically_derived_product_storage_scale import BiologicallyDerivedProductStorageScale
...
class BiologicallyDerivedProductStorage(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        """
        super().__init__(
            resourceType="BiologicallyDerivedProductStorage",
            id_=id_,
            meta=meta,
            extension=extension,
