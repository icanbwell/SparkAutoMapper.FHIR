...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.example_payment_type_codes import ExamplePaymentTypeCodes
    # End Import for CodeableConcept for type
    from spark_auto_mapper_fhir.complex_types.money import Money
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for adjustmentReason
    from spark_auto_mapper_fhir.value_sets.payment_adjustment_reason_codes import PaymentAdjustmentReasonCodes
...
class ExplanationOfBenefitPayment(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        adjustmentReason: Optional[CodeableConcept[PaymentAdjustmentReasonCodes] ] = None,
