...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.substance_polymer_starting_material import SubstancePolymerStartingMaterial
...
class SubstancePolymerMonomerSet(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        """
        super().__init__(
            resourceType="SubstancePolymerMonomerSet",
            id_=id_,
            meta=meta,
            extension=extension,
            ratioType=ratioType,
