...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.id import id
    from spark_auto_mapper_fhir.complex_types.structure_map_group_type_mode import StructureMapGroupTypeMode
    from spark_auto_mapper_fhir.complex_types.string import string
    from spark_auto_mapper_fhir.backbone_elements.structure_map_input import StructureMapInput
...
class StructureMapGroup(FhirBackboneElementBase):
    ...
    mapping is invoked.
        ...
        """
        super().__init__(
            resourceType="StructureMapGroup",
            id_=id_,
            meta=meta,
            extension=extension,
            name=name,
