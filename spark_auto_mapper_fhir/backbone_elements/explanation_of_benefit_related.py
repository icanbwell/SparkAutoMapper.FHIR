...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.example_related_claim_relationship_codes import ExampleRelatedClaimRelationshipCodesCode
...
class ExplanationOfBenefitRelated(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        relationship: Optional[CodeableConcept[ExampleRelatedClaimRelationshipCodesCode] ] = None,
