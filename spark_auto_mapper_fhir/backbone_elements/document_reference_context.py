...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.facility_type_code_value_set import FacilityTypeCodeValueSetCode
...
class DocumentReferenceContext(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        practiceSetting: Optional[CodeableConcept[PracticeSettingCodeValueSetCode] ] = None,
