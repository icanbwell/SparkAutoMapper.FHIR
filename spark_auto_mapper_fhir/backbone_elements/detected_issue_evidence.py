...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.manifestation_and_symptom_codes import ManifestationAndSymptomCodesCode
...
class DetectedIssueEvidence(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        code: Optional[FhirList[CodeableConcept[ManifestationAndSymptomCodesCode] ]] = None,
