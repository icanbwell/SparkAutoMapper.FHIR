...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.resource_version_policy import ResourceVersionPolicyCode
    # readHistory (boolean)
    # updateCreate (boolean)
    # conditionalCreate (boolean)
    # conditionalRead (ConditionalReadStatus)
    from spark_auto_mapper_fhir.value_sets.conditional_read_status import ConditionalReadStatusCode
    # conditionalUpdate (boolean)
    # conditionalDelete (ConditionalDeleteStatus)
    from spark_auto_mapper_fhir.value_sets.conditional_delete_status import ConditionalDeleteStatusCode
    # referencePolicy (ReferenceHandlingPolicy)
    from spark_auto_mapper_fhir.value_sets.reference_handling_policy import ReferenceHandlingPolicyCode
