...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.capability_statement_interaction import CapabilityStatementInteraction
    from spark_auto_mapper_fhir.complex_types.resource_version_policy import ResourceVersionPolicy
    from spark_auto_mapper_fhir.complex_types.boolean import boolean
    from spark_auto_mapper_fhir.complex_types.boolean import boolean
    from spark_auto_mapper_fhir.complex_types.boolean import boolean
    from spark_auto_mapper_fhir.complex_types.conditional_read_status import ConditionalReadStatus
    from spark_auto_mapper_fhir.complex_types.boolean import boolean
    from spark_auto_mapper_fhir.complex_types.conditional_delete_status import ConditionalDeleteStatus
    from spark_auto_mapper_fhir.complex_types.reference_handling_policy import ReferenceHandlingPolicy
...
class CapabilityStatementResource(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        searchInclude: Optional[FhirList[string]] = None,
        searchRevInclude: Optional[FhirList[string]] = None,
