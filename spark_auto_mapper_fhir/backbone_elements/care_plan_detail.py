...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.care_plan_activity_kind import CarePlanActivityKind
    ...
    from spark_auto_mapper_fhir.complex_types.care_plan_activity_status import CarePlanActivityStatus
