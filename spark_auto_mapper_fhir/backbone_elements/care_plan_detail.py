...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.care_plan_activity_kind import CarePlanActivityKindCode
    ...
    from spark_auto_mapper_fhir.value_sets.care_plan_activity_status import CarePlanActivityStatusCode
...
class CarePlanDetail(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        performer: Optional[FhirList[Reference [Union[Practitioner, PractitionerRole, Organization, RelatedPerson, Patient, CareTeam, HealthcareService, Device]]]] = None,
        productCodeableConcept: Optional[CodeableConcept[SNOMEDCTMedicationCodesCode] ] = None,
