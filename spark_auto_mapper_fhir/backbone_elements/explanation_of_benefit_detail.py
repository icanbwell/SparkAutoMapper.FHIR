...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.example_revenue_center_codes import ExampleRevenueCenterCodes
    # End Import for CodeableConcept for revenue
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for category
    from spark_auto_mapper_fhir.value_sets.benefit_category_codes import BenefitCategoryCodes
    ...
    from spark_auto_mapper_fhir.value_sets.example_program_reason_codes import ExampleProgramReasonCodes
    ...
    from spark_auto_mapper_fhir.backbone_elements.explanation_of_benefit_sub_detail import ExplanationOfBenefitSubDetail
...
class ExplanationOfBenefitDetail(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        programCode: Optional[FhirList[CodeableConcept[ExampleProgramReasonCodes] ]] = None,
