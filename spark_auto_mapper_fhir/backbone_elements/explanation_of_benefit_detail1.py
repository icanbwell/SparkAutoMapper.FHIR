...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.explanation_of_benefit_sub_detail1 import ExplanationOfBenefitSubDetail1
...
class ExplanationOfBenefitDetail1(FhirBackboneElementBase):
    ...
    this item.
        ...
        """
        super().__init__(
            resourceType="ExplanationOfBenefitDetail1",
            id_=id_,
            meta=meta,
            extension=extension,
