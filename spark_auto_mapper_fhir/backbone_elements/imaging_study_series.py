...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.imaging_study_performer import ImagingStudyPerformer
    # instance (ImagingStudy.Instance)
    from spark_auto_mapper_fhir.backbone_elements.imaging_study_instance import ImagingStudyInstance
