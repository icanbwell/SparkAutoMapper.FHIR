...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.measure_report_population import MeasureReportPopulation
    # measureScore (Quantity)
    from spark_auto_mapper_fhir.complex_types.quantity import Quantity
    # stratifier (MeasureReport.Stratifier)
    from spark_auto_mapper_fhir.backbone_elements.measure_report_stratifier import MeasureReportStratifier
