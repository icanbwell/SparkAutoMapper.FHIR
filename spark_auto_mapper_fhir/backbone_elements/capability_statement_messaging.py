...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.capability_statement_endpoint import CapabilityStatementEndpoint
    ...
    from spark_auto_mapper_fhir.backbone_elements.capability_statement_supported_message import CapabilityStatementSupportedMessage
...
class CapabilityStatementMessaging(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        supportedMessage: Optional[FhirList[CapabilityStatementSupportedMessage ]] = None,
    ) -> None:
        """
