...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.participation_role_type import ParticipationRoleType
    ...
    from spark_auto_mapper_fhir.backbone_elements.audit_event_network import AuditEventNetwork
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
...
class AuditEventAgent(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        who: Optional[Reference [Union[PractitionerRole, Practitioner, Organization, Device, Patient, RelatedPerson]]] = None,
        ...
        :param type: Specification of the participation type the user plays when performing the
    event.
