...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.medication_knowledge_characteristic_codes import MedicationKnowledgeCharacteristicCodesCode
...
class MedicationKnowledgeDrugCharacteristic(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        type_: Optional[CodeableConcept[MedicationKnowledgeCharacteristicCodesCode] ] = None,
