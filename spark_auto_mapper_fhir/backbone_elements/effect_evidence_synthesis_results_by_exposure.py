...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.evidence_variant_state import EvidenceVariantStateCode
    ...
    from spark_auto_mapper_fhir.resources.risk_evidence_synthesis import RiskEvidenceSynthesis
