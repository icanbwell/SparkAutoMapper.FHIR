...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.network_type_codes import NetworkTypeCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.benefit_term_codes import BenefitTermCodesCode
    # End Import for CodeableConcept for term
    # benefit (CoverageEligibilityResponse.Benefit)
    from spark_auto_mapper_fhir.backbone_elements.coverage_eligibility_response_benefit import CoverageEligibilityResponseBenefit
    # authorizationRequired (boolean)
    from spark_auto_mapper_fhir.complex_types.boolean import boolean
    # authorizationSupporting (CodeableConcept)
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for authorizationSupporting
    from spark_auto_mapper_fhir.value_sets.coverage_eligibility_response_auth_support_codes import CoverageEligibilityResponseAuthSupportCodesCode
...
class CoverageEligibilityResponseItem(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        authorizationSupporting: Optional[FhirList[CodeableConcept[CoverageEligibilityResponseAuthSupportCodesCode] ]] = None,
