...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.medication_administration_performer_function_codes import MedicationAdministrationPerformerFunctionCodes
...
class MedicationAdministrationPerformer(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        function: Optional[CodeableConcept[MedicationAdministrationPerformerFunctionCodes] ] = None,
