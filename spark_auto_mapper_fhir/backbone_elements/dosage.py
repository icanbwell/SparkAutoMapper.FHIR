...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.snomedct_additional_dosage_instructions import SNOMEDCTAdditionalDosageInstructions
    # End Import for CodeableConcept for additionalInstruction
    from spark_auto_mapper_fhir.complex_types.string import string
    from spark_auto_mapper_fhir.backbone_elements.timing import Timing
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for site
    from spark_auto_mapper_fhir.value_sets.snomedct_anatomical_structure_for_administration_site_codes import SNOMEDCTAnatomicalStructureForAdministrationSiteCodes
    # End Import for CodeableConcept for site
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for route
    from spark_auto_mapper_fhir.value_sets.snomedct_route_codes import SNOMEDCTRouteCodes
    # End Import for CodeableConcept for route
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for method
    from spark_auto_mapper_fhir.value_sets.snomedct_administration_method_codes import SNOMEDCTAdministrationMethodCodes
...
class Dosage(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        additionalInstruction: Optional[FhirList[CodeableConcept[SNOMEDCTAdditionalDosageInstructions] ]] = None,
        patientInstruction: Optional[FhirString ] = None,
        timing: Optional[Timing ] = None,
        site: Optional[CodeableConcept[SNOMEDCTAnatomicalStructureForAdministrationSiteCodes] ] = None,
