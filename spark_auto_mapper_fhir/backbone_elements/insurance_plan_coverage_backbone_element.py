...
from spark_auto_mapper_fhir.backbone_elements.benefit_backbone_element import BenefitBackboneElement
...
class InsurancePlanCoverageBackboneElement(FhirBackboneElementBase):
    def __init__(
        ...
        """
        super().__init__(type_=type_, benefit=benefit, network=network)
