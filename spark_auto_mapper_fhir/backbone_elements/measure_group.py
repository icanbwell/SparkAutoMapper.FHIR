...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.measure_population import MeasurePopulation
    from spark_auto_mapper_fhir.backbone_elements.measure_stratifier import MeasureStratifier
