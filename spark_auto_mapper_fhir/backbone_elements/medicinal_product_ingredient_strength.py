...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.medicinal_product_ingredient_reference_strength import MedicinalProductIngredientReferenceStrength
...
class MedicinalProductIngredientStrength(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        referenceStrength: Optional[FhirList[MedicinalProductIngredientReferenceStrength ]] = None,
    ) -> None:
        """
        An ingredient of a manufactured item or pharmaceutical product.
