...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.structure_map_context_type import StructureMapContextTypeCode
    # element (string)
    # variable (id)
    # listMode (StructureMapTargetListMode)
    from spark_auto_mapper_fhir.value_sets.structure_map_target_list_mode import StructureMapTargetListModeCode
    # listRuleId (id)
    # transform (StructureMapTransform)
    from spark_auto_mapper_fhir.value_sets.structure_map_transform import StructureMapTransformCode
