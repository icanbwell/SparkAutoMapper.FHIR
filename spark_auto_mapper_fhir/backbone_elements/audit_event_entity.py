...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.audit_event_entity_type import AuditEventEntityTypeCode
    # End Import for CodeableConcept for type_
    # role (Coding)
    # End Import for References for role
    # Import for CodeableConcept for role
    from spark_auto_mapper_fhir.value_sets.audit_event_entity_role import AuditEventEntityRoleCode
    # End Import for CodeableConcept for role
    # lifecycle (Coding)
    # End Import for References for lifecycle
    # Import for CodeableConcept for lifecycle
    from spark_auto_mapper_fhir.value_sets.object_lifecycle_events import ObjectLifecycleEventsCode
