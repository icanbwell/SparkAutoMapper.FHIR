...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.string import string
    from spark_auto_mapper_fhir.backbone_elements.value_set_designation import ValueSetDesignation
    from spark_auto_mapper_fhir.backbone_elements.value_set_contains import ValueSetContains
