...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.primary_source_type import Primary_source_typeCode
    # End Import for CodeableConcept for type_
    # communicationMethod (CodeableConcept)
    # End Import for References for communicationMethod
    # Import for CodeableConcept for communicationMethod
    from spark_auto_mapper_fhir.value_sets.verificationresult_communication_method import Verificationresult_communication_methodCode
    ...
    from spark_auto_mapper_fhir.value_sets.validation_status import Validation_statusCode
    ...
    from spark_auto_mapper_fhir.value_sets.push_type_available import Push_type_availableCode
...
class VerificationResultPrimarySource(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        communicationMethod: Optional[FhirList[CodeableConcept[Verificationresult_communication_methodCode] ]] = None,
        ...
        pushTypeAvailable: Optional[FhirList[CodeableConcept[Push_type_availableCode] ]] = None,
    ) -> None:
        """
