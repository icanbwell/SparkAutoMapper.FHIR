...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.property_representation import PropertyRepresentationCode
    # sliceName (string)
    ...
    from spark_auto_mapper_fhir.backbone_elements.element_definition_slicing import ElementDefinitionSlicing
    # short (string)
    # definition (markdown)
    ...
    from spark_auto_mapper_fhir.backbone_elements.element_definition_base import ElementDefinitionBase
    # contentReference (uri)
    # type_ (ElementDefinition.Type)
    from spark_auto_mapper_fhir.backbone_elements.element_definition_type import ElementDefinitionType
    ...
    from spark_auto_mapper_fhir.backbone_elements.element_definition_example import ElementDefinitionExample
    # minValueDate (date)
    ...
    from spark_auto_mapper_fhir.backbone_elements.element_definition_constraint import ElementDefinitionConstraint
    # mustSupport (boolean)
    # isModifier (boolean)
    # isModifierReason (string)
    # isSummary (boolean)
    # binding (ElementDefinition.Binding)
    from spark_auto_mapper_fhir.backbone_elements.element_definition_binding import ElementDefinitionBinding
    # mapping (ElementDefinition.Mapping)
    from spark_auto_mapper_fhir.backbone_elements.element_definition_mapping import ElementDefinitionMapping
