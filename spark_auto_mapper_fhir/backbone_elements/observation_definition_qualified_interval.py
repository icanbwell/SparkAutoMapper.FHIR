...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.observation_range_category import ObservationRangeCategoryCode
    # range (Range)
    ...
    from spark_auto_mapper_fhir.value_sets.observation_reference_range_meaning_codes import ObservationReferenceRangeMeaningCodesCode
    ...
    from spark_auto_mapper_fhir.value_sets.observation_reference_range_applies_to_codes import ObservationReferenceRangeAppliesToCodesCode
...
class ObservationDefinitionQualifiedInterval(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        context: Optional[CodeableConcept[ObservationReferenceRangeMeaningCodesCode] ] = None,
        appliesTo: Optional[FhirList[CodeableConcept[ObservationReferenceRangeAppliesToCodesCode] ]] = None,
