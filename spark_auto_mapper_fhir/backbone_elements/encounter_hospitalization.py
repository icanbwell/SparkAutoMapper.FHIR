...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.special_arrangements import SpecialArrangements
    ...
    from spark_auto_mapper_fhir.value_sets.discharge_disposition import DischargeDisposition
...
class EncounterHospitalization(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        specialArrangement: Optional[FhirList[CodeableConcept[SpecialArrangements] ]] = None,
