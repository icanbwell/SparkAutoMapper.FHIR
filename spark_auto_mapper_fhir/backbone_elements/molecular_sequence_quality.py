...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.fda__standard_sequence import FDA_StandardSequence
    ...
    from spark_auto_mapper_fhir.complex_types.decimal import decimal
    from spark_auto_mapper_fhir.complex_types.decimal import decimal
    from spark_auto_mapper_fhir.backbone_elements.molecular_sequence_roc import MolecularSequenceRoc
...
class MolecularSequenceQuality(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        :param type: INDEL / SNP / Undefined variant.
