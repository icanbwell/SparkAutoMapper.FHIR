...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.example_scenario_operation import ExampleScenarioOperation
    from spark_auto_mapper_fhir.backbone_elements.example_scenario_alternative import ExampleScenarioAlternative
