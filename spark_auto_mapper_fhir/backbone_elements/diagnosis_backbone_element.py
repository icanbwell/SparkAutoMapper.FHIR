...
from spark_auto_mapper_fhir.valuesets.diagnosis_on_admission import (
    DiagnosisOnAdmissionCode,
)
from spark_auto_mapper_fhir.valuesets.diagnosis_related_group import (
...
class DiagnosisBackboneElement(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        onAdmission: Optional[CodeableConcept[DiagnosisOnAdmissionCode]] = None,
        packageCode: Optional[CodeableConcept[DiagnosisRelatedGroupCode]] = None,
    ):
        """
