...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.assertion_direction_type import AssertionDirectionTypeCode
    ...
    from spark_auto_mapper_fhir.value_sets.assertion_operator_type import AssertionOperatorTypeCode
    # path (string)
    # requestMethod (TestScriptRequestMethodCode)
    from spark_auto_mapper_fhir.value_sets.test_script_request_method_code import TestScriptRequestMethodCodeCode
    # requestURL (string)
    ...
    from spark_auto_mapper_fhir.value_sets.assertion_response_types import AssertionResponseTypesCode
    # responseCode (string)
    # sourceId (id)
