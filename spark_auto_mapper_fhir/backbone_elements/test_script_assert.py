...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.string import string
    from spark_auto_mapper_fhir.complex_types.assertion_direction_type import AssertionDirectionType
    from spark_auto_mapper_fhir.complex_types.string import string
    from spark_auto_mapper_fhir.complex_types.string import string
    from spark_auto_mapper_fhir.complex_types.string import string
    ...
    from spark_auto_mapper_fhir.complex_types.assertion_operator_type import AssertionOperatorType
    from spark_auto_mapper_fhir.complex_types.string import string
    from spark_auto_mapper_fhir.complex_types.test_script_request_method_code import TestScriptRequestMethodCode
    from spark_auto_mapper_fhir.complex_types.string import string
    from spark_auto_mapper_fhir.complex_types.code import code
    from spark_auto_mapper_fhir.complex_types.assertion_response_types import AssertionResponseTypes
    from spark_auto_mapper_fhir.complex_types.string import string
