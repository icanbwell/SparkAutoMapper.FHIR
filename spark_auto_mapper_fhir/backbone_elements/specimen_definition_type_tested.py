...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.specimen_contained_preference import SpecimenContainedPreferenceCode
    ...
    from spark_auto_mapper_fhir.value_sets.rejection_criterion import RejectionCriterionCode
...
class SpecimenDefinitionTypeTested(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        rejectionCriterion: Optional[FhirList[CodeableConcept[RejectionCriterionCode] ]] = None,
