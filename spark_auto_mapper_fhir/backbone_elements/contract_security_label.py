...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.contract_resource_security_control_codes import ContractResourceSecurityControlCodes
...
class ContractSecurityLabel(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        control: Optional[FhirList[Coding[ContractResourceSecurityControlCodes] ]] = None,
    ) -> None:
        """
