...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.operation_parameter_use import OperationParameterUse
    ...
    from spark_auto_mapper_fhir.backbone_elements.operation_definition_binding import OperationDefinitionBinding
    from spark_auto_mapper_fhir.backbone_elements.operation_definition_referenced_from import OperationDefinitionReferencedFrom
