...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.plan_definition_condition import PlanDefinitionCondition
    ...
    from spark_auto_mapper_fhir.backbone_elements.plan_definition_related_action import PlanDefinitionRelatedAction
    ...
    from spark_auto_mapper_fhir.backbone_elements.plan_definition_participant import PlanDefinitionParticipant
    ...
    from spark_auto_mapper_fhir.value_sets.action_grouping_behavior import ActionGroupingBehaviorCode
    # selectionBehavior (ActionSelectionBehavior)
    from spark_auto_mapper_fhir.value_sets.action_selection_behavior import ActionSelectionBehaviorCode
    # requiredBehavior (ActionRequiredBehavior)
    from spark_auto_mapper_fhir.value_sets.action_required_behavior import ActionRequiredBehaviorCode
    # precheckBehavior (ActionPrecheckBehavior)
    from spark_auto_mapper_fhir.value_sets.action_precheck_behavior import ActionPrecheckBehaviorCode
    # cardinalityBehavior (ActionCardinalityBehavior)
    from spark_auto_mapper_fhir.value_sets.action_cardinality_behavior import ActionCardinalityBehaviorCode
    # definitionCanonical (canonical)
    from spark_auto_mapper_fhir.fhir_types.canonical import FhirCanonical
    # definitionUri (uri)
    # transform (canonical)
    # dynamicValue (PlanDefinition.DynamicValue)
    from spark_auto_mapper_fhir.backbone_elements.plan_definition_dynamic_value import PlanDefinitionDynamicValue
