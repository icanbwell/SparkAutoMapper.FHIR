...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.audit_event_agent_network_type import AuditEventAgentNetworkType
...
class AuditEventNetwork(FhirBackboneElementBase):
    ...
    event.
        :param type: An identifier for the type of network access point that originated the audit
    event.
        """
        super().__init__(
