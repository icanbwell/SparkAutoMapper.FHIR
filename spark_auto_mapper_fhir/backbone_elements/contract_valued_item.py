...
class ContractValuedItem(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        responsible: Optional[Reference [Union[Organization, Patient, Practitioner, PractitionerRole, RelatedPerson]]] = None,
        recipient: Optional[Reference [Union[Organization, Patient, Practitioner, PractitionerRole, RelatedPerson]]] = None,
