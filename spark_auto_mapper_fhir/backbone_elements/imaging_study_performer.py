...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.imaging_study_series_performer_function import ImagingStudySeriesPerformerFunctionCode
...
class ImagingStudyPerformer(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        function: Optional[CodeableConcept[ImagingStudySeriesPerformerFunctionCode] ] = None,
        actor: Reference [Union[Practitioner, PractitionerRole, Organization, CareTeam, Patient, Device, RelatedPerson]],
    ) -> None:
        """
