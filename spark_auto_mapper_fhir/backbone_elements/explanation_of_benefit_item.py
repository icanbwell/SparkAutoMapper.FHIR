...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.example_service_place_codes import ExampleServicePlaceCodesCode
...
class ExplanationOfBenefitItem(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        locationCodeableConcept: Optional[CodeableConcept[ExampleServicePlaceCodesCode] ] = None,
