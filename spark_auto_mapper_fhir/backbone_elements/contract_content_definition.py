...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.contract_resource_definition_type_codes import ContractResourceDefinitionTypeCodes
    # End Import for CodeableConcept for type
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for subType
    from spark_auto_mapper_fhir.value_sets.contract_resource_definition_subtype_codes import ContractResourceDefinitionSubtypeCodes
...
class ContractContentDefinition(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        subType: Optional[CodeableConcept[ContractResourceDefinitionSubtypeCodes] ] = None,
