...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.immunization_target_disease_codes import ImmunizationTargetDiseaseCodes
...
class ImmunizationProtocolApplied(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        targetDisease: Optional[FhirList[CodeableConcept[ImmunizationTargetDiseaseCodes] ]] = None,
    ) -> None:
        """
