...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.condition_stage_type import ConditionStageTypeCode
...
class ConditionStage(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        assessment: Optional[FhirList[Reference [Union[ClinicalImpression, DiagnosticReport, Observation]]]] = None,
