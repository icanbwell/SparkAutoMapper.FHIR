...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.medication_knowledge_substitution import MedicationKnowledgeSubstitution
    # schedule (MedicationKnowledge.Schedule)
    from spark_auto_mapper_fhir.backbone_elements.medication_knowledge_schedule import MedicationKnowledgeSchedule
    # maxDispense (MedicationKnowledge.MaxDispense)
    from spark_auto_mapper_fhir.backbone_elements.medication_knowledge_max_dispense import MedicationKnowledgeMaxDispense
