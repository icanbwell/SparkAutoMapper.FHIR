...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.structure_map_source import StructureMapSource
    from spark_auto_mapper_fhir.backbone_elements.structure_map_target import StructureMapTarget
    from spark_auto_mapper_fhir.backbone_elements.structure_map_rule import StructureMapRule
    from spark_auto_mapper_fhir.backbone_elements.structure_map_dependent import StructureMapDependent
