...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.act_substance_admin_substitution_code import ActSubstanceAdminSubstitutionCode
    # End Import for CodeableConcept for type_
    # reason (CodeableConcept)
    # End Import for References for reason
    # Import for CodeableConcept for reason
    from spark_auto_mapper_fhir.value_sets.substance_admin_substitution_reason import SubstanceAdminSubstitutionReason
...
class MedicationDispenseSubstitution(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        reason: Optional[FhirList[CodeableConcept[SubstanceAdminSubstitutionReason] ]] = None,
