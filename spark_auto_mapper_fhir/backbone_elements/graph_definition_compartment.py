...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.graph_compartment_use import GraphCompartmentUseCode
    ...
    from spark_auto_mapper_fhir.value_sets.graph_compartment_rule import GraphCompartmentRuleCode
    # expression (string)
    # description (string)
