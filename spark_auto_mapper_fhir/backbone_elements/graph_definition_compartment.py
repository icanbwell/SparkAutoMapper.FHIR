...
if TYPE_CHECKING:
    from spark_auto_mapper_fhir.complex_types.graph_compartment_use import GraphCompartmentUse
    from spark_auto_mapper_fhir.complex_types.compartment_type import CompartmentType
    from spark_auto_mapper_fhir.complex_types.graph_compartment_rule import GraphCompartmentRule
