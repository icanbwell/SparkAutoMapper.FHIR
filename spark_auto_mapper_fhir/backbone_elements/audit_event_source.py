...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.audit_event_source_type import AuditEventSourceTypeCode
...
class AuditEventSource(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        observer: Reference [Union[PractitionerRole, Practitioner, Organization, Device, Patient, RelatedPerson]],
