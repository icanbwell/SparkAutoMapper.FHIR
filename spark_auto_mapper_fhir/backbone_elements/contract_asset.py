...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.contract_resource_asset_scope_codes import ContractResourceAssetScopeCodes
    # End Import for CodeableConcept for scope
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for type
    from spark_auto_mapper_fhir.value_sets.contract_resource_asset_type_codes import ContractResourceAssetTypeCodes
    ...
    from spark_auto_mapper_fhir.value_sets.contract_resource_asset_sub__type_codes import ContractResourceAssetSub_TypeCodes
    # End Import for CodeableConcept for subtype
    from spark_auto_mapper_fhir.complex_types.coding import Coding
    # Import for CodeableConcept for relationship
    from spark_auto_mapper_fhir.value_sets.consent_content_class import ConsentContentClass
    ...
    from spark_auto_mapper_fhir.value_sets.contract_resource_asset_availiability_codes import ContractResourceAssetAvailiabilityCodes
...
class ContractAsset(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        type: Optional[FhirList[CodeableConcept[ContractResourceAssetTypeCodes] ]] = None,
        typeReference: Optional[FhirList[Reference [Union[Resource]]]] = None,
        subtype: Optional[FhirList[CodeableConcept[ContractResourceAssetSub_TypeCodes] ]] = None,
        ...
        periodType: Optional[FhirList[CodeableConcept[ContractResourceAssetAvailiabilityCodes] ]] = None,
