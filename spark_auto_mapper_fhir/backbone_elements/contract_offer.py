...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.contract_term_type_codes import ContractTermTypeCodes
    # End Import for CodeableConcept for type
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for decisionMode
    from spark_auto_mapper_fhir.value_sets.contract_resource_decision_mode_codes import ContractResourceDecisionModeCodes
...
class ContractOffer(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        decisionMode: Optional[FhirList[CodeableConcept[ContractResourceDecisionModeCodes] ]] = None,
