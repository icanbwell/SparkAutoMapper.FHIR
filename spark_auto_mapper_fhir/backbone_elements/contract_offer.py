...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.act_consent_directive import ActConsentDirective
    ...
    from spark_auto_mapper_fhir.value_sets.contract_resource_decision_mode_codes import ContractResourceDecisionModeCodesCode
...
class ContractOffer(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        decisionMode: Optional[FhirList[CodeableConcept[ContractResourceDecisionModeCodesCode] ]] = None,
