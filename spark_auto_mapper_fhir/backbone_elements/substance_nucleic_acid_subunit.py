...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    from spark_auto_mapper_fhir.backbone_elements.substance_nucleic_acid_linkage import SubstanceNucleicAcidLinkage
    from spark_auto_mapper_fhir.backbone_elements.substance_nucleic_acid_sugar import SubstanceNucleicAcidSugar
