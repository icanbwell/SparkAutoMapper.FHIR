...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.contract_resource_asset_context_codes import ContractResourceAssetContextCodes
...
class ContractContext(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        code: Optional[FhirList[CodeableConcept[ContractResourceAssetContextCodes] ]] = None,
