...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.claim_care_team_role_codes import ClaimCareTeamRoleCodes
    # End Import for CodeableConcept for role
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for qualification
    from spark_auto_mapper_fhir.value_sets.example_provider_qualification_codes import ExampleProviderQualificationCodes
...
class ClaimCareTeam(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        qualification: Optional[CodeableConcept[ExampleProviderQualificationCodes] ] = None,
    ) -> None:
        """
