...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.backbone_elements.nutrition_order_nutrient import NutritionOrderNutrient
    # texture (NutritionOrder.Texture)
    from spark_auto_mapper_fhir.backbone_elements.nutrition_order_texture import NutritionOrderTexture
    # fluidConsistencyType (CodeableConcept)
    from spark_auto_mapper_fhir.complex_types.codeable_concept import CodeableConcept
    # Import for CodeableConcept for fluidConsistencyType
    from spark_auto_mapper_fhir.value_sets.fluid_consistency_type_codes import FluidConsistencyTypeCodesCode
...
class NutritionOrderOralDiet(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        fluidConsistencyType: Optional[FhirList[CodeableConcept[FluidConsistencyTypeCodesCode] ]] = None,
