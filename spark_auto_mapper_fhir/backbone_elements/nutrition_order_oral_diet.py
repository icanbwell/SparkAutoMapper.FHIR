...
if TYPE_CHECKING:
    ...
    from spark_auto_mapper_fhir.value_sets.fluid_consistency_type_codes import FluidConsistencyTypeCodes
...
class NutritionOrderOralDiet(FhirBackboneElementBase):
    ...
    def __init__(
        ...
        *,
        ...
        fluidConsistencyType: Optional[FhirList[CodeableConcept[FluidConsistencyTypeCodes] ]] = None,
