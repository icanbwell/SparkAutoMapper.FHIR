...
class RepositoryTypeValues:
    ...
    TheURLIsTheRESTfulOrOtherKindOfAPIThatCanAccessToTheResult_ = RepositoryType("openapi")
    ResultCannotBeAccessUnlessAnAccountIsLoggedIn = RepositoryType("login")
    ResultNeedToBeFetchedWithAPIAndNeedLOGIN_OrCookiesAreRequiredWhenVisitingTheLinkOfResource_ = RepositoryType("oauth")
