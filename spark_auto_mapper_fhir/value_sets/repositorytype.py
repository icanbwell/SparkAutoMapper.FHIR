...
class RepositorytypeValues:
    ...
    TheUrlIsTheRestfulOrOtherKindOfApiThatCanAccessToTheResult = Repositorytype("openapi")
    ResultCannotBeAccessUnlessAnAccountIsLoggedIn = Repositorytype("login")
    ResultNeedToBeFetchedWithApiAndNeedLoginOrCookiesAreRequiredWhenVisitingTheLinkOfResource = Repositorytype("oauth")
