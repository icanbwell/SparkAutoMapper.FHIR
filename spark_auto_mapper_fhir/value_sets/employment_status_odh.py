...
class EmploymentStatusODHValues:
    ...
    """
    ActCoverageAssessmentObservationValue = EmploymentStatusODH("_ActCoverageAssessmentObservationValue")
    """
    Indicates the result of a particular allergy test.  E.g. Negative, Mild,
    Moderate, Severe
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    AllergyTestValue = EmploymentStatusODH("_AllergyTestValue")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    CompositeMeasureScoring = EmploymentStatusODH("_CompositeMeasureScoring")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    CoverageLimitObservationValue = EmploymentStatusODH("_CoverageLimitObservationValue")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    CriticalityObservationValue = EmploymentStatusODH("_CriticalityObservationValue")
    """
    Concepts representing whether a person does or does not currently have a job
    or is not currently in the labor pool seeking employment.
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    _EmploymentStatus = EmploymentStatusODH("_EmploymentStatus")
    """
    Description: The domain contains genetic analysis specific observation values,
    e.g. Homozygote, Heterozygote, etc.
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    GeneticObservationValue = EmploymentStatusODH("_GeneticObservationValue")
    """
    Observation values used to indicate the type of scoring (e.g. proportion,
    ratio) used by a health quality measure.
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    ObservationMeasureScoring = EmploymentStatusODH("_ObservationMeasureScoring")
    """
    Observation values used to indicate what kind of health quality measure is
    used.
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    ObservationMeasureType = EmploymentStatusODH("_ObservationMeasureType")
    """
    Observation values used to assert various populations that a subject falls
    into.
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    ObservationPopulationInclusion = EmploymentStatusODH("_ObservationPopulationInclusion")
    """
    PartialCompletionScale
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    PartialCompletionScale = EmploymentStatusODH("_PartialCompletionScale")
    """
    Observation values used to indicate security observation metadata.
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    SecurityObservationValue = EmploymentStatusODH("_SecurityObservationValue")
    """
    Potential values for observations of severity.
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    SeverityObservation = EmploymentStatusODH("_SeverityObservation")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    _SubjectBodyPosition = EmploymentStatusODH("_SubjectBodyPosition")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    VerificationOutcome = EmploymentStatusODH("_VerificationOutcomeValue")
    """
    Concepts that describe an individual's typical arrangement of working hours
    for an occupation.
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    _WorkSchedule = EmploymentStatusODH("_WorkSchedule")
    """
    AnnotationValue
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    AnnotationValue = EmploymentStatusODH("_AnnotationValue")
    """
    Description:Used in a patient care message to value simple clinical (non-lab)
    observations.
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    CommonClinicalObservation = EmploymentStatusODH("_CommonClinicalObservationValue")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    IndividualCaseSafetyReportValueDomains = EmploymentStatusODH("_IndividualCaseSafetyReportValueDomains")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    IndicationValue = EmploymentStatusODH("_IndicationValue")
