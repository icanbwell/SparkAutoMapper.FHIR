...
class ContractResourceStatusCodesCode(GenericTypeCode):
    """
    ContractResourceStatusCodes
    From: http://hl7.org/fhir/contract-status in valuesets.xml
    ...
    """
    codeset: FhirUri = "http://hl7.org/fhir/contract-status"
