...
class ReligiousAffiliationValues:
    ...
    AfrocaribbeanReligions = ReligiousAffiliation("1003")
    ...
    BabiBahaiFaiths = ReligiousAffiliation("1008")
    ...
    ChristiannoncatholicNonspecific = ReligiousAffiliation("1013")
    ...
    JehovahsWitnesses = ReligiousAffiliation("1025")
    ...
    NonromanCatholic = ReligiousAffiliation("1034")
    ...
    ProcessThe = ReligiousAffiliation("1039")
    Reformedpresbyterian = ReligiousAffiliation("1040")
    ...
    ProtestantNoDenomination = ReligiousAffiliation("1078")
