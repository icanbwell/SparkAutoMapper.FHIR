...
class CoverageEligibilityResponseAuthSupportCodesCodeValues:
    ...
    DiagnosticImageOrder = CoverageEligibilityResponseAuthSupportCodesCode("diagnosticimageorder")
    DiagnosticImageReport = CoverageEligibilityResponseAuthSupportCodesCode("diagnosticimagereport")
    ProfessionalReport = CoverageEligibilityResponseAuthSupportCodesCode("professionalreport")
