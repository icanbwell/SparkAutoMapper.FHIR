...
class ContextOfUseValueSetCodeValues:
    ...
    ActAccountCode = ContextOfUseValueSetCode("_ActAccountCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActAdjudicationCode = ContextOfUseValueSetCode("_ActAdjudicationCode")
    """
    Actions to be carried out by the recipient of the Adjudication Result
    information.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActAdjudicationResultActionCode = ContextOfUseValueSetCode(
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActBillableModifierCode = ContextOfUseValueSetCode("_ActBillableModifierCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActBillingArrangementCode = ContextOfUseValueSetCode("_ActBillingArrangementCode")
    """
    Type of bounded ROI.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActBoundedROICode = ContextOfUseValueSetCode("_ActBoundedROICode")
    """
    Description:The type and scope of responsibility taken-on by the performer of
    the Act for a specific subject of care.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActCareProvision = ContextOfUseValueSetCode("_ActCareProvisionCode")
    """
    Description: Coded types of attachments included to support a healthcare
    claim.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActClaimAttachmentCategoryCode = ContextOfUseValueSetCode(
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActConsentType = ContextOfUseValueSetCode("_ActConsentType")
    """
    Constrains the ActCode to the domain of Container Registration
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActContainerRegistrationCode = ContextOfUseValueSetCode(
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActControlVariable = ContextOfUseValueSetCode("_ActControlVariable")
    """
    Response to an insurance coverage eligibility query or authorization request.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActCoverageConfirmationCode = ContextOfUseValueSetCode(
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActCoverageLimitCode = ContextOfUseValueSetCode("_ActCoverageLimitCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActCoverageTypeCode = ContextOfUseValueSetCode("_ActCoverageTypeCode")
    """
    Codes dealing with the management of Detected Issue observations
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActDetectedIssueManagementCode = ContextOfUseValueSetCode(
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActExposureCode = ContextOfUseValueSetCode("_ActExposureCode")
    """
    ActFinancialTransactionCode
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActFinancialTransactionCode = ContextOfUseValueSetCode(
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActIncidentCode = ContextOfUseValueSetCode("_ActIncidentCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActInformationAccessCode = ContextOfUseValueSetCode("_ActInformationAccessCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActInformationAccessContextCode = ContextOfUseValueSetCode(
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActInformationCategoryCode = ContextOfUseValueSetCode("_ActInformationCategoryCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActInvoiceElementCode = ContextOfUseValueSetCode("_ActInvoiceElementCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActInvoiceElementSummaryCode = ContextOfUseValueSetCode(
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActInvoiceOverrideCode = ContextOfUseValueSetCode("_ActInvoiceOverrideCode")
    """
    Provides codes associated with ActClass value of LIST (working list)
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActListCode = ContextOfUseValueSetCode("_ActListCode")
    """
    Identifies types of monitoring programs
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActMonitoringProtocolCode = ContextOfUseValueSetCode("_ActMonitoringProtocolCode")
    """
    Description:Concepts representing indications (reasons for clinical action)
    other than diagnosis and symptoms.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActNonObservationIndicationCode = ContextOfUseValueSetCode(
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActObservationVerification = ContextOfUseValueSetCode(
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActPaymentCode = ContextOfUseValueSetCode("_ActPaymentCode")
    """
    Identifies types of dispensing events
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActPharmacySupplyType = ContextOfUseValueSetCode("_ActPharmacySupplyType")
    """
    Description:Types of policies that further specify the ActClassPolicy value
    set.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActPolicyType = ContextOfUseValueSetCode("_ActPolicyType")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActProductAcquisitionCode = ContextOfUseValueSetCode("_ActProductAcquisitionCode")
    """
    Transportation of a specimen.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActSpecimenTransportCode = ContextOfUseValueSetCode("_ActSpecimenTransportCode")
    """
    Set of codes related to specimen treatments
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActSpecimenTreatmentCode = ContextOfUseValueSetCode("_ActSpecimenTreatmentCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActSubstanceAdministrationCode = ContextOfUseValueSetCode(
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActTaskCode = ContextOfUseValueSetCode("_ActTaskCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActTransportationModeCode = ContextOfUseValueSetCode("_ActTransportationModeCode")
    """
    Identifies the kinds of observations that can be performed
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ObservationType = ContextOfUseValueSetCode("_ObservationType")
    """
    Shape of the region on the object being referenced
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ROIOverlayShape = ContextOfUseValueSetCode("_ROIOverlayShape")
    """
    Description:Indicates that result data has been corrected.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    Corrected = ContextOfUseValueSetCode("C")
    """
    Code set to define specialized/allowed diets
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    Diet = ContextOfUseValueSetCode("DIET")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    DrugProgram = ContextOfUseValueSetCode("DRUGPRG")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    Final = ContextOfUseValueSetCode("F")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    Preliminary = ContextOfUseValueSetCode("PRLMN")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    SecurityObservationType = ContextOfUseValueSetCode("SECOBS")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    SubsidizedFeeForServiceProgram = ContextOfUseValueSetCode("SUBSIDFFS")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    _workersCompensationProgram = ContextOfUseValueSetCode("WRKCOMP")
    """
    An identifying code for healthcare interventions/procedures.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActProcedureCode = ContextOfUseValueSetCode("_ActProcedureCode")
    """
    Domain provides the root for HL7-defined detailed or rich codes for the Act
    classes.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    HL7DefinedActCodes = ContextOfUseValueSetCode("_HL7DefinedActCodes")
    """
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    COPAY = ContextOfUseValueSetCode("COPAY")
    """
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    DEDUCT = ContextOfUseValueSetCode("DEDUCT")
    """
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    DOSEIND = ContextOfUseValueSetCode("DOSEIND")
    """
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    PRA = ContextOfUseValueSetCode("PRA")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    Storage = ContextOfUseValueSetCode("STORE")
    """
    An account represents a grouping of financial transactions that are tracked
    and reported together with a single balance. 	 	Examples of account codes
    (types) are Patient billing accounts (collection of charges), Cost centers;
