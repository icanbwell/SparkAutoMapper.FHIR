...
class ActConsentType(GenericTypeCode):
    ...
    """
    codeset: FhirUri = "http://terminology.hl7.org/ValueSet/v3-ActConsentType"
    """
...
class ActConsentTypeValues:
    ...
    ActAccountCode = ActConsentType("_ActAccountCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActAdjudicationCode = ActConsentType("_ActAdjudicationCode")
    """
    Actions to be carried out by the recipient of the Adjudication Result
    information.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActAdjudicationResultActionCode = ActConsentType("_ActAdjudicationResultActionCode")
    """
    Definition:An identifying modifier code for healthcare interventions or
    procedures.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActBillableModifierCode = ActConsentType("_ActBillableModifierCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActBillingArrangementCode = ActConsentType("_ActBillingArrangementCode")
    """
    Type of bounded ROI.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActBoundedROICode = ActConsentType("_ActBoundedROICode")
    """
    Description:The type and scope of responsibility taken-on by the performer of
    the Act for a specific subject of care.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActCareProvision = ActConsentType("_ActCareProvisionCode")
    """
    Description: Coded types of attachments included to support a healthcare
    claim.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActClaimAttachmentCategoryCode = ActConsentType("_ActClaimAttachmentCategoryCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActConsentType_ = ActConsentType("_ActConsentType")
    """
    Constrains the ActCode to the domain of Container Registration
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActContainerRegistrationCode = ActConsentType("_ActContainerRegistrationCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActControlVariable = ActConsentType("_ActControlVariable")
    """
    Response to an insurance coverage eligibility query or authorization request.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActCoverageConfirmationCode = ActConsentType("_ActCoverageConfirmationCode")
    """
    Criteria that are applicable to the authorized coverage.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActCoverageLimitCode = ActConsentType("_ActCoverageLimitCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActCoverageTypeCode = ActConsentType("_ActCoverageTypeCode")
    """
    Codes dealing with the management of Detected Issue observations
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActDetectedIssueManagementCode = ActConsentType("_ActDetectedIssueManagementCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActExposureCode = ActConsentType("_ActExposureCode")
    """
    ActFinancialTransactionCode
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActFinancialTransactionCode = ActConsentType("_ActFinancialTransactionCode")
    """
    Set of codes indicating the type of incident or accident.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActIncidentCode = ActConsentType("_ActIncidentCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActInformationAccessCode = ActConsentType("_ActInformationAccessCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActInformationAccessContextCode = ActConsentType("_ActInformationAccessContextCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActInformationCategoryCode = ActConsentType("_ActInformationCategoryCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActInvoiceElementCode = ActConsentType("_ActInvoiceElementCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActInvoiceElementSummaryCode = ActConsentType("_ActInvoiceElementSummaryCode")
    """
    Includes coded responses that will occur as a result of the adjudication of an
    electronic invoice at a summary level and provides guidance on interpretation
    of the referenced adjudication results.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActInvoiceOverrideCode = ActConsentType("_ActInvoiceOverrideCode")
    """
    Provides codes associated with ActClass value of LIST (working list)
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActListCode = ActConsentType("_ActListCode")
    """
    Identifies types of monitoring programs
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActMonitoringProtocolCode = ActConsentType("_ActMonitoringProtocolCode")
    """
    Description:Concepts representing indications (reasons for clinical action)
    other than diagnosis and symptoms.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActNonObservationIndicationCode = ActConsentType("_ActNonObservationIndicationCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActObservationVerification = ActConsentType("_ActObservationVerificationType")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActPaymentCode = ActConsentType("_ActPaymentCode")
    """
    Identifies types of dispensing events
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActPharmacySupplyType = ActConsentType("_ActPharmacySupplyType")
    """
    Description:Types of policies that further specify the ActClassPolicy value
    set.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActPolicyType = ActConsentType("_ActPolicyType")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActProductAcquisitionCode = ActConsentType("_ActProductAcquisitionCode")
    """
    Transportation of a specimen.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActSpecimenTransportCode = ActConsentType("_ActSpecimenTransportCode")
    """
    Set of codes related to specimen treatments
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActSpecimenTreatmentCode = ActConsentType("_ActSpecimenTreatmentCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActSubstanceAdministrationCode = ActConsentType("_ActSubstanceAdministrationCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActTaskCode = ActConsentType("_ActTaskCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActTransportationModeCode = ActConsentType("_ActTransportationModeCode")
    """
    Identifies the kinds of observations that can be performed
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ObservationType = ActConsentType("_ObservationType")
    """
    Shape of the region on the object being referenced
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ROIOverlayShape = ActConsentType("_ROIOverlayShape")
    """
    Description:Indicates that result data has been corrected.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    Corrected = ActConsentType("C")
    """
    Code set to define specialized/allowed diets
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    Diet = ActConsentType("DIET")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    DrugProgram = ActConsentType("DRUGPRG")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    Preliminary = ActConsentType("PRLMN")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    SecurityObservationType = ActConsentType("SECOBS")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    SubsidizedFeeForServiceProgram = ActConsentType("SUBSIDFFS")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    _workersCompensationProgram = ActConsentType("WRKCOMP")
    """
    An identifying code for healthcare interventions/procedures.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActProcedureCode = ActConsentType("_ActProcedureCode")
    """
    Domain provides the root for HL7-defined detailed or rich codes for the Act
    classes.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    HL7DefinedActCodes = ActConsentType("_HL7DefinedActCodes")
    """
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    COPAY = ActConsentType("COPAY")
    """
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    DEDUCT = ActConsentType("DEDUCT")
    """
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    DOSEIND = ActConsentType("DOSEIND")
    """
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    PRA = ActConsentType("PRA")
    """
