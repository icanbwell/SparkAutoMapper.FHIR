...
class Dischargedisposition(FhirValueSetBase):
    """ """
...
class DischargedispositionValues:
    ...
    Rehabilitation = Dischargedisposition("rehab")
    SkilledNursingFacility = Dischargedisposition("snf")
    Other = Dischargedisposition("oth")
