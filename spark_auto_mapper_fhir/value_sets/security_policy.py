...
class SecurityPolicyValues:
    ...
    ActAccountCode = SecurityPolicy("_ActAccountCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActAdjudicationCode = SecurityPolicy("_ActAdjudicationCode")
    """
    Actions to be carried out by the recipient of the Adjudication Result
    information.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActAdjudicationResultActionCode = SecurityPolicy("_ActAdjudicationResultActionCode")
    """
    Definition:An identifying modifier code for healthcare interventions or
    procedures.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActBillableModifierCode = SecurityPolicy("_ActBillableModifierCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActBillingArrangementCode = SecurityPolicy("_ActBillingArrangementCode")
    """
    Type of bounded ROI.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActBoundedROICode = SecurityPolicy("_ActBoundedROICode")
    """
    Description:The type and scope of responsibility taken-on by the performer of
    the Act for a specific subject of care.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActCareProvision = SecurityPolicy("_ActCareProvisionCode")
    """
    Description: Coded types of attachments included to support a healthcare
    claim.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActClaimAttachmentCategoryCode = SecurityPolicy("_ActClaimAttachmentCategoryCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActConsentType = SecurityPolicy("_ActConsentType")
    """
    Constrains the ActCode to the domain of Container Registration
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActContainerRegistrationCode = SecurityPolicy("_ActContainerRegistrationCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActControlVariable = SecurityPolicy("_ActControlVariable")
    """
    Response to an insurance coverage eligibility query or authorization request.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActCoverageConfirmationCode = SecurityPolicy("_ActCoverageConfirmationCode")
    """
    Criteria that are applicable to the authorized coverage.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActCoverageLimitCode = SecurityPolicy("_ActCoverageLimitCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActCoverageTypeCode = SecurityPolicy("_ActCoverageTypeCode")
    """
    Codes dealing with the management of Detected Issue observations
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActDetectedIssueManagementCode = SecurityPolicy("_ActDetectedIssueManagementCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActExposureCode = SecurityPolicy("_ActExposureCode")
    """
    ActFinancialTransactionCode
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActFinancialTransactionCode = SecurityPolicy("_ActFinancialTransactionCode")
    """
    Set of codes indicating the type of incident or accident.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActIncidentCode = SecurityPolicy("_ActIncidentCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActInformationAccessCode = SecurityPolicy("_ActInformationAccessCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActInformationAccessContextCode = SecurityPolicy("_ActInformationAccessContextCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActInformationCategoryCode = SecurityPolicy("_ActInformationCategoryCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActInvoiceElementCode = SecurityPolicy("_ActInvoiceElementCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActInvoiceElementSummaryCode = SecurityPolicy("_ActInvoiceElementSummaryCode")
    """
    Includes coded responses that will occur as a result of the adjudication of an
    electronic invoice at a summary level and provides guidance on interpretation
    of the referenced adjudication results.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActInvoiceOverrideCode = SecurityPolicy("_ActInvoiceOverrideCode")
    """
    Provides codes associated with ActClass value of LIST (working list)
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActListCode = SecurityPolicy("_ActListCode")
    """
    Identifies types of monitoring programs
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActMonitoringProtocolCode = SecurityPolicy("_ActMonitoringProtocolCode")
    """
    Description:Concepts representing indications (reasons for clinical action)
    other than diagnosis and symptoms.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActNonObservationIndicationCode = SecurityPolicy("_ActNonObservationIndicationCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActObservationVerification = SecurityPolicy("_ActObservationVerificationType")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActPaymentCode = SecurityPolicy("_ActPaymentCode")
    """
    Identifies types of dispensing events
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActPharmacySupplyType = SecurityPolicy("_ActPharmacySupplyType")
    """
    Description:Types of policies that further specify the ActClassPolicy value
    set.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActPolicyType = SecurityPolicy("_ActPolicyType")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActProductAcquisitionCode = SecurityPolicy("_ActProductAcquisitionCode")
    """
    Transportation of a specimen.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActSpecimenTransportCode = SecurityPolicy("_ActSpecimenTransportCode")
    """
    Set of codes related to specimen treatments
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActSpecimenTreatmentCode = SecurityPolicy("_ActSpecimenTreatmentCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActSubstanceAdministrationCode = SecurityPolicy("_ActSubstanceAdministrationCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActTaskCode = SecurityPolicy("_ActTaskCode")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActTransportationModeCode = SecurityPolicy("_ActTransportationModeCode")
    """
    Identifies the kinds of observations that can be performed
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ObservationType = SecurityPolicy("_ObservationType")
    """
    Shape of the region on the object being referenced
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ROIOverlayShape = SecurityPolicy("_ROIOverlayShape")
    """
    Description:Indicates that result data has been corrected.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    Corrected = SecurityPolicy("C")
    """
    Code set to define specialized/allowed diets
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    Diet = SecurityPolicy("DIET")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    DrugProgram = SecurityPolicy("DRUGPRG")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    Preliminary = SecurityPolicy("PRLMN")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    SecurityObservationType = SecurityPolicy("SECOBS")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    SubsidizedFeeForServiceProgram = SecurityPolicy("SUBSIDFFS")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    _workersCompensationProgram = SecurityPolicy("WRKCOMP")
    """
    An identifying code for healthcare interventions/procedures.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    ActProcedureCode = SecurityPolicy("_ActProcedureCode")
    """
    Domain provides the root for HL7-defined detailed or rich codes for the Act
    classes.
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    HL7DefinedActCodes = SecurityPolicy("_HL7DefinedActCodes")
    """
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    COPAY = SecurityPolicy("COPAY")
    """
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    DEDUCT = SecurityPolicy("DEDUCT")
    """
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    DOSEIND = SecurityPolicy("DOSEIND")
    """
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    PRA = SecurityPolicy("PRA")
    """
