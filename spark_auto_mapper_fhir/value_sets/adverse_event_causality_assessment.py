...
class AdverseEventCausalityAssessmentCode(GenericTypeCode):
    ...
    """
    codeset: FhirUri = "http://terminology.hl7.org/CodeSystem/adverse-event-causality-assess"
...
class AdverseEventCausalityAssessmentCodeValues:
    ...
    From: http://terminology.hl7.org/CodeSystem/adverse-event-causality-assess in valuesets.xml
    """
    Conditional_Classified = AdverseEventCausalityAssessmentCode("Conditional-Classified")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/adverse-event-causality-assess in valuesets.xml
    """
    Unassessable_Unclassifiable = AdverseEventCausalityAssessmentCode("Unassessable-Unclassifiable")
