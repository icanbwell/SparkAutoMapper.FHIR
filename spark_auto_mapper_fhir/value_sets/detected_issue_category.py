...
class DetectedIssueCategoryCode(GenericTypeCode):
    """
    DetectedIssueCategory
    From: http://hl7.org/fhir/ValueSet/detectedissue-category in valuesets.xml
...
class DetectedIssueCategoryCodeValues:
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ActCode in v3-codesystems.xml
    """
    _workersCompensationProgram = DetectedIssueCategoryCode("WRKCOMP")
    """
