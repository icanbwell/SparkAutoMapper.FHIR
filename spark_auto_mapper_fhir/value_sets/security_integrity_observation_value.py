...
class SecurityIntegrityObservationValueValues:
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    AllergyTestValue = SecurityIntegrityObservationValue("_AllergyTestValue")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    _EmploymentStatus = SecurityIntegrityObservationValue("_EmploymentStatus")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    SeverityObservation = SecurityIntegrityObservationValue("_SeverityObservation")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    _SubjectBodyPosition = SecurityIntegrityObservationValue("_SubjectBodyPosition")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    VerificationOutcome = SecurityIntegrityObservationValue("_VerificationOutcomeValue")
    """
    Concepts that describe an individual's typical arrangement of working hours
    for an occupation.
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    _WorkSchedule = SecurityIntegrityObservationValue("_WorkSchedule")
    """
    AnnotationValue
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    AnnotationValue = SecurityIntegrityObservationValue("_AnnotationValue")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-ObservationValue in v3-codesystems.xml
    """
    IndicationValue = SecurityIntegrityObservationValue("_IndicationValue")
