...
class ServiceDeliveryLocationRoleType(GenericTypeCode):
    """
    ...
    """
    codeset_v3_ServiceDeliveryLocationRoleType: FhirUri = (
        "http://terminology.hl7.org/ValueSet/v3-ServiceDeliveryLocationRoleType"
    )
    """
...
class ServiceDeliveryLocationRoleTypeValues:
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    AssignedRoleType = ServiceDeliveryLocationRoleType("_AssignedRoleType")
    """
    Defines types of certifications for all entities
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    CertifiedEntityType = ServiceDeliveryLocationRoleType("_CertifiedEntityType")
    """
    A role type used to qualify a person's legal status within a country or
    nation.
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    CitizenRoleType = ServiceDeliveryLocationRoleType("_CitizenRoleType")
    """
    Types of contact for Role code "CON"
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    ContactRoleType = ServiceDeliveryLocationRoleType("_ContactRoleType")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    IdentifiedEntityType = ServiceDeliveryLocationRoleType("_IdentifiedEntityType")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    MemberRoleType = ServiceDeliveryLocationRoleType("_MemberRoleType")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    SpecimenRoleType = ServiceDeliveryLocationRoleType("_SpecimenRoleType")
    """
    A party that makes a claim for coverage under a policy.
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    Claimant = ServiceDeliveryLocationRoleType("CLAIM")
    """
    Community Laboratory
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    CommunityLaboratory = ServiceDeliveryLocationRoleType("communityLaboratory")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    Guarantor = ServiceDeliveryLocationRoleType("GT")
    """
    Home Health
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    HomeHealth = ServiceDeliveryLocationRoleType("homeHealth")
    """
    Laboratory
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    Laboratory = ServiceDeliveryLocationRoleType("laboratory")
    """
    Pathologist
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    Pathologist = ServiceDeliveryLocationRoleType("pathologist")
    """
    Policy holder for the insurance policy.
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    PolicyHolder = ServiceDeliveryLocationRoleType("PH")
    """
    Phlebotomist
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    Phlebotomist = ServiceDeliveryLocationRoleType("phlebotomist")
    """
    A party that meets the eligibility criteria for coverage under a program.
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    ProgramEligible = ServiceDeliveryLocationRoleType("PROG")
    """
    The recipient for the service(s) and/or product(s) when they are not the
    covered party.
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    Patient = ServiceDeliveryLocationRoleType("PT")
    """
    Self
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    Self = ServiceDeliveryLocationRoleType("subject")
    """
    Third Party
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    ThirdParty = ServiceDeliveryLocationRoleType("thirdParty")
    """
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    DEP = ServiceDeliveryLocationRoleType("DEP")
    """
    A party covered under a policy based on association with a subscriber.
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    Dependent = ServiceDeliveryLocationRoleType("DEPEN")
    """
    A member of the covered party's family. This could be the spouse, a parent, a
    grand parent, a sibling, etc.
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    FamilyMember = ServiceDeliveryLocationRoleType("FM")
    """
    A party covered under a policy as the policyholder.
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    Individual = ServiceDeliveryLocationRoleType("INDIV")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    NamedInsured = ServiceDeliveryLocationRoleType("NAMED")
    """
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    PSYCHCF = ServiceDeliveryLocationRoleType("PSYCHCF")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/v3-RoleCode in v3-codesystems.xml
    """
    Subscriber = ServiceDeliveryLocationRoleType("SUBSCR")
