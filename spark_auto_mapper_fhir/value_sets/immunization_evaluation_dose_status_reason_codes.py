...
class ImmunizationEvaluationDoseStatusReasonCodesCodeValues:
    ...
    From: http://terminology.hl7.org/CodeSystem/immunization-evaluation-dose-status-reason in valuesets.xml
    """
    AdverseStorageCondition = ImmunizationEvaluationDoseStatusReasonCodesCode("advstorage")
    """
    ...
    From: http://terminology.hl7.org/CodeSystem/immunization-evaluation-dose-status-reason in valuesets.xml
    """
    AdministeredOutsideRecommendedSchedule = ImmunizationEvaluationDoseStatusReasonCodesCode("outsidesched")
    """
