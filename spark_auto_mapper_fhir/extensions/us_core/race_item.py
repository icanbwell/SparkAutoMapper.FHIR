...
from spark_auto_mapper_fhir.value_sets_custom.us_core.detailed_ethnicity import (
    DetailedEthnicity,
)
from spark_auto_mapper_fhir.value_sets_custom.us_core.omb_ethnicity_category import (
