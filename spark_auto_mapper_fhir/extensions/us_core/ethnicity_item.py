...
class EthnicityItem(FhirExtensionBase):
    # noinspection PyPep8Naming
    def __init__(
        self,
        url: Optional[FhirUri] = None,
        valueCoding: Optional[Union[OMBEthnicityCategory,
                                    DetailedEthnicity]] = None,
        ...
        super().__init__(
            url=url, valueCoding=valueCoding, valueString=valueString
        )
