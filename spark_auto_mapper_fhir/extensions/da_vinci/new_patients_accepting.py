...
from spark_auto_mapper_fhir.valuesets.da_vinci.accepting_patients import AcceptingPatientsCode


class AcceptingPatientsExtension(ExtensionBase):
    # noinspection PyPep8Naming
    def __init__(
        self, valueCodeableConcept: CodeableConcept[AcceptingPatientsCode]
    ):
        """
        Accepting Patients
